!(function(e, t) {
    ...
    P = createCommonjsModule(function(e) {
      ...
      ;(i.inspectSource = function(e) {
        ...
        (e.exports = function(e, i, o, a) {
          ...
          s && (y(o, 'name') || h(o, 'name', i)),
            e[i] !== o &&
              (s && (y(o, t) || h(o, t, e[i] ? '' + e[i] : n.join(String(i)))),
              e === r
                ? (e[i] = o)
                : a
                ? e[i]
  ...
  var k,
    ...
    T = S,
    I = {}.toString,
    A = Object('z').propertyIsEnumerable(0)
      ? Object
      : function(e) {
          return 'String' ==
            (function(e) {
    ...
    x =
      ...
      function(e, t, r) {
        ...
        if (k && t != t) {
          ...
          for (; a > s; s++) if ((k || s in o) && o[s] === t) return k || s || 0
        return !k && -1
      }),
        ...
        ? function(e, t) {
            for (
              ...
              for (
                var u,
                  c = A(arguments[n++]),
                  l = o ? K(c).concat(o(c)) : K(c),
                  d = l.length,
                  p = 0;
                d > p;

              )
                (u = l[p++]), (s && !a.call(c, u)) || (r[u] = c[u])
            return r
          }
        : F
  T(T.S + T.F, 'Object', { assign: H })
  i.Object.assign
  !(function(e) {
    if (!e.fetch) {
      var t = {
  ...
  var G = createCommonjsModule(function(e, t) {
    ...
    var i = (function() {
      function Logger(e) {
        void 0 === e && (e = 5),
          (this._level = e),
          (this._console = this._availableConsole())
      }
      return (
        ...
        (Logger.prototype._perform = function(e) {
          for (var t, r = [], i = 1; i < arguments.length; i++)
            r[i - 1] = arguments[i]
          var n = ['trace', 'debug', 'info', 'warn', 'error', 'silent'].splice(
              this.level
            ),
            o = 'log' === e ? 'debug' : e
          ;-1 !== n.indexOf(o) &&
            (this._console[e] || (e = 'log'),
            (t = this._console[e]).apply.apply(t, [this._console].concat(r)))
        }),
        Logger
      )
    })()
  ...
  var Y = G.Logger,
    Q = (function() {
      ...
      return (
        Object.defineProperty(Timeline.prototype, 'events', {
          get: function() {
            return this._events
          },
          enumerable: !0,
        ...
        (Timeline.prototype.before = function(e) {
          if ('number' != typeof e) {
            ...
            for (var r in this._events)
              this._events.hasOwnProperty(r) && t.push(this._events[r])
    ...
    Z = (function() {
      function MKDialog(e, t) {
        void 0 === t && (t = ''),
          ...
          [this.id, this.scrimId, this.styleId].forEach(function(e) {
            try {
      ...
      return (
        (MKDialog.serverDialog = function(e) {
          var t = new this(e.message, e.explanation)
          return (
            e.okButtonAction &&
              e.okButtonAction.url &&
              (t._okButtonActionURL = e.okButtonAction.url),
            e.okButtonString && (t._okButtonString = e.okButtonString),
        ...
        Object.defineProperty(MKDialog.prototype, 'actions', {
          get: function() {
            return this.cancelButton
              ? '<nav>' + this.cancelButton + this.okButton + '</nav>'
              : '<nav>' + this.okButton + '</nav>'
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(MKDialog.prototype, 'cancelButton', {
          get: function() {
            if ('string' == typeof this._cancelButtonString)
              return '<button>' + this._cancelButtonString + '</button>'
          },
          set: function(e) {
        ...
        Object.defineProperty(MKDialog.prototype, 'okButton', {
          get: function() {
            return this.hasOKButtonAction
              ? "<button data-ok-action-url='" +
                  this._okButtonActionURL +
                  "'>" +
                  this._okButtonString +
                  '</button>'
              : '<button>' + this._okButtonString + '</button>'
          },
          enumerable: !0,
          configurable: !0
        }),
        (MKDialog.prototype.present = function() {
          ...
          ;(n = '' + n + this.actions),
            ...
            setTimeout(function() {
              document
                .querySelector('#' + i.id + ' nav *:first-child')
                .addEventListener('mouseup', function() {
                  i.parentElement.removeChild(i), r.parentElement.removeChild(r)
                }),
                e.hasOKButtonAction &&
                  document
                    .querySelector('#' + i.id + ' nav *:last-child')
    ...
    re = (function(e) {
      function MKError(t, r) {
        ...
        return (
          (i.errorCode = X),
          r || 'string' != typeof t
            ? ((i.name = i.errorCode = t || X),
              r && (i.message = i.description = r))
            : ((i.name = i.errorCode = X), (i.message = i.description = t)),
          te.push(i),
          Error.captureStackTrace && Error.captureStackTrace(i, MKError),
          (i.presentDialog = function() {
            i.dialog
              ? Z.serverDialog(i.dialog).present()
              : new Z(i.message).present()
          }),
          i
        )
      }
      return (
        __extends(MKError, e),
        Object.defineProperty(MKError, 'errors', {
          get: function() {
            return te
          },
          enumerable: !0,
        ...
        (MKError.responseError = function(e) {
          var t = e.status,
            r = e.statusText
          return new this(J[t] || 'NETWORK_ERROR', r || '' + t)
        }),
        (MKError.serverError = function(e) {
          ...
          return (
            'STREAM_UPSELL' === s &&
              r.okButtonAction &&
              r.okButtonAction.url &&
              (r.okButtonAction.url = r.okButtonAction.url.replace(
        ...
        (MKError.ACCESS_DENIED = J[403]),
        (MKError.AUTHORIZATION_ERROR = ee[2002]),
        (MKError.CONFIGURATION_ERROR = 'CONFIGURATION_ERROR'),
        (MKError.CONTENT_EQUIVALENT = 'CONTENT_EQUIVALENT'),
        (MKError.CONTENT_RESTRICTED = ee[3082]),
        (MKError.CONTENT_UNAVAILABLE = ee[3076]),
        (MKError.DEVICE_LIMIT = ee[3059]),
        ...
        (MKError.NOT_FOUND = ee[1010]),
        (MKError.PARSE_ERROR = 'PARSE_ERROR'),
        (MKError.PLAY_ACTIVITY = 'PLAY_ACTIVITY'),
        (MKError.QUOTA_EXCEEDED = J[429]),
        (MKError.REQUEST_ERROR = J[400]),
        (MKError.SERVER_ERROR = ee[5002]),
        (MKError.SERVICE_UNAVAILABLE = J[503]),
        (MKError.STREAM_UPSELL = ee[3084]),
        (MKError.SUBSCRIPTION_ERROR = ee[3063]),
        (MKError.TOKEN_EXPIRED = ee[2034]),
        (MKError.UNAUTHORIZED_ERROR = J[401]),
        (MKError.UNKNOWN_ERROR = X),
  ...
  function formatMediaTime(e, t) {
    ...
    var o = []
    return (
      i ? (o.push('' + i), o.push(n < 10 ? '0' + n : '' + n)) : o.push('' + n),
      o.push(e < 10 ? '0' + e : '' + e),
      o.join(t)
    )
  }
  function formattedMediaURL(e) {
    ...
    var t = e.match(ie),
      ...
      o = t[4]
    return (
      -1 !== ['album', 'playlist'].indexOf(i) && o
        ? ((i = 'song'), (n = o))
        : 'podcast' === i && o && ((i = 'episode'), (n = o)),
      { storefrontId: r, kind: i, contentId: n }
    )
  }
  ...
  var ne = createCommonjsModule(function(e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.generateUUID = function() {
        for (var e = strRandomizer() + strRandomizer(); e.length < 16; )
          e += strRandomizer()
        return e.slice(0, 16)
      }),
    ...
    ae =
      ...
      createCommonjsModule(function(e, t) {
        ...
        var r = (function() {
          ...
          return (
            (GenericStorage.prototype.clear = function() {
              this._data = {}
            }),
          ...
          (t.setCookie = function(e, t, r, i) {
            ...
            var n = new Date(),
              o = /\./.test(window.location.hostname)
                ...
                : ''
            ;/^(?:[a-z\-]+\.)?(?:music|itunes)\.apple\.com$/i.test(o) &&
              (o = 'domain=apple.com'),
  ...
  !(function(e) {
    ...
    (function(e) {
      ;(e[(e.NOT_APPLICABLE = 0)] = 'NOT_APPLICABLE'),
        (e[(e.OTHER = 1)] = 'OTHER'),
        (e[(e.TRACK_SKIPPED_FORWARDS = 2)] = 'TRACK_SKIPPED_FORWARDS'),
        (e[(e.PLAYBACK_MANUALLY_PAUSED = 3)] = 'PLAYBACK_MANUALLY_PAUSED'),
        (e[(e.PLAYBACK_SUSPENDED = 4)] = 'PLAYBACK_SUSPENDED'),
        (e[(e.MANUALLY_SELECTED_PLAYBACK_OF_A_DIFF_ITEM = 5)] =
          'MANUALLY_SELECTED_PLAYBACK_OF_A_DIFF_ITEM'),
        (e[(e.PLAYBACK_PAUSED_DUE_TO_INACTIVITY = 6)] =
          'PLAYBACK_PAUSED_DUE_TO_INACTIVITY'),
        (e[(e.NATURAL_END_OF_TRACK = 7)] = 'NATURAL_END_OF_TRACK'),
        (e[(e.PLAYBACK_STOPPED_DUE_TO_SESSION_TIMEOUT = 8)] =
          'PLAYBACK_STOPPED_DUE_TO_SESSION_TIMEOUT'),
        (e[(e.TRACK_BANNED = 9)] = 'TRACK_BANNED'),
        (e[(e.FAILED_TO_LOAD = 10)] = 'FAILED_TO_LOAD'),
        (e[(e.PAUSED_ON_TIMEOUT = 11)] = 'PAUSED_ON_TIMEOUT'),
        (e[(e.SCRUB_BEGIN = 12)] = 'SCRUB_BEGIN'),
        (e[(e.SCRUB_END = 13)] = 'SCRUB_END'),
        (e[(e.TRACK_SKIPPED_BACKWARDS = 14)] = 'TRACK_SKIPPED_BACKWARDS'),
        (e[(e.NOT_SUPPORTED_BY_CLIENT = 15)] = 'NOT_SUPPORTED_BY_CLIENT'),
        (e[(e.QUICK_PLAY = 16)] = 'QUICK_PLAY'),
        (e[(e.EXITED_APPLICATION = 17)] = 'EXITED_APPLICATION')
    })(ce || (ce = {})),
    (function(e) {
  ...
  var _e,
    ge = (function() {
      function PlayActivity(e, t, r, i) {
        ;(this.accessToken = e),
          ...
          i &&
            ((this._appInfo = i.app),
            (this._logInfo = i.logInfo || !1),
            (this._utcOffset = i.utcOffset || new Date().getTimezoneOffset()),
            (this._userAgent = i.userAgent),
            (this.sourceType =
              i.sourceType && 'number' == typeof i.sourceType
                ? i.sourceType
                : ye.MUSICKIT)),
          (this.buildVersion = this._generateBuildVersion())
      }
      return (
        Object.defineProperty(PlayActivity.prototype, 'appID', {
          get: function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    r.sent(), (r.label = 2)
                  case 2:
                    return (t = this.timeline.last) &&
                      t.endReasonType === ce.EXITED_APPLICATION
                      ? [2, this.timeline.pop()]
                      : [2]
                }
              })
            ...
            __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(s) {
                switch (s.label) {
                  case 0:
                    return (
                      (r = this.timeline.length > 0),
                      !e && r
                        ? ((n = this._previousDescriptor()).eventType ===
                            de.PLAY_END && delete n.endReasonType,
                          (i = Object.assign(n, {
                        ...
                        : r
                        ? (n = this._previousDescriptor()).eventType !==
                            de.PLAY_START && n.endReasonType !== ce.SCRUB_END
                          ? [3, 2]
                          : ((o = Object.assign(n, {
                              eventType: de.PLAY_END,
                              endReasonType:
                                ce.MANUALLY_SELECTED_PLAYBACK_OF_A_DIFF_ITEM,
                              timestamp: Date.now(),
                              position: t
                            })),
                            [4, this._addToTimeline(o)])
                        : [3, 2]
                    )
                  case 1:
        ...
        (PlayActivity.prototype.scrub = function(e, t) {
          return (
            void 0 === e && (e = 0),
            void 0 === t && (t = ce.SCRUB_BEGIN),
            __awaiter(this, void 0, void 0, function() {
              var r, i
              return __generator(this, function(n) {
                return (
                  (r = this._previousDescriptor()),
                  t === ce.SCRUB_END && r.endReasonType !== ce.SCRUB_BEGIN
                    ? [
                        2,
                        Promise.reject(
                          re.playActivityError(
        ...
        (PlayActivity.prototype.skip = function(e, t, r) {
          return (
            void 0 === t && (t = ce.TRACK_SKIPPED_FORWARDS),
            void 0 === r && (r = 0),
            __awaiter(this, void 0, void 0, function() {
        ...
        (PlayActivity.prototype.stop = function(e, t) {
          return (
            void 0 === e && (e = 0),
            void 0 === t && (t = ce.NATURAL_END_OF_TRACK),
            __awaiter(this, void 0, void 0, function() {
              var r, i
              return __generator(this, function(n) {
                switch (n.label) {
                  case 0:
                    return (r = this._previousDescriptor()).endReasonType !==
                      ce.EXITED_APPLICATION
                      ? [3, 2]
                      : [4, this.timeline.pop()]
                  case 1:
                    n.sent(),
                      ...
                      (n.label = 2)
                  case 2:
                    return r.eventType === de.PLAY_START ||
                      r.endReasonType === ce.SCRUB_END
                      ? ((i = Object.assign(r, {
                          eventType: de.PLAY_END,
                          timestamp: Date.now(),
                          endReasonType: t,
        ...
        (PlayActivity.prototype.build = function(e, t) {
          if ((void 0 === e && (e = this.timeline.last), !e))
            throw re.playActivityError(
          ...
          var r = e.cloudId,
            ...
            y = void 0 === f ? 0 : f,
            b = e.timestamp,
            m = '-1' === c ? {} : { 'subscription-adam-id': c }
          if (
            (r && (m['cloud-id'] = r),
            t || (t = this.timeline.before(e)),
            u === de.PLAY_END && !t)
          )
            throw re.playActivityError(
          ...
          if (
            (u === de.PLAY_START
              ? (w['event-reason-hint-type'] = _
                  ? le.CONTAINER_CHANGED
                  : le.NOT_SPECIFIED)
              : u === de.PLAY_END &&
                t &&
                void 0 !== t.position &&
                ((w['end-position-in-milliseconds'] = P),
                P > g && (w['media-duration-in-milliseconds'] = P),
                (w['start-position-in-milliseconds'] = Math.round(
                  1e3 * t.position
                )),
                (w['end-reason-type'] = a)),
            i)
            ...
            ;(w['feature-name'] = '' + (i.name || se.MUSICKIT)),
              S &&
                ((w['container-type'] = S),
                S === ue.PLAYLIST
                  ? (w['container-ids'] = { 'global-playlist-id': i.id })
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              switch (r.label) {
                ...
                case 2:
                  return r.sent(), me('amupaee', '', '/', 0), [3, 4]
                case 3:
                  return (
                    r.sent(), [2, Promise.reject(re.playActivityError('flush'))]
                  )
                case 4:
            ...
            return __generator(this, function(i) {
              switch (i.label) {
                ...
                case 2:
                  return (
                    i.sent(),
                    this._logInfo && console.info('play activity:', r),
                    [2, r]
                  )
                case 3:
              ...
              switch (r.label) {
                ...
                case 1:
                  return (
                    (t = r.sent()),
                    this._mode !== fe.AUTO ||
                    e.endReasonType === ce.EXITED_APPLICATION
                      ? [3, 3]
                      : [4, this.send(this.build())]
                  )
                case 2:
                  return r.sent(), [3, 4]
                case 3:
                  me('amupaee', btoa(JSON.stringify(this.build())), '/'),
                    (r.label = 4)
                case 4:
                  return [2, t]
              }
        ...
        (PlayActivity.prototype._generateBuildVersion = function() {
          var e,
            ...
            n = '0.0',
            o = /mobile/.test(t)
          o && /android|adr/.test(t)
            ? ((i = 'Android'),
              (e = t.match(/(?:android|adr)\ ((\d+[._])+\d+)/)))
            : o && /iphone|ipad|ipod/.test(t)
            ? ((i = 'iOS'),
              (e = t.match(/os\ ((\d+[._])+\d+)\ like\ mac\ os\ x/)))
            : /tizen/.test(t)
            ? ((i = 'Tizen'), (e = t.match(/tizen (.*)/)))
            : /web0s|webos/.test(t)
            ? ((i = 'WebOS'), (e = t.match(/[web0s|webos] (.*)/)))
            : !o && /cros/.test(t)
            ? (i = 'ChromeOS')
            : !o && /macintosh/.test(t)
            ? ((i = 'macOS'), (e = t.match(/os\ x\ ((\d+[._])+\d+)\b/)))
            : !o && /linux/.test(t)
            ? (i = 'Linux')
            : !o &&
              /windows/.test(t) &&
              ((i = 'Windows'), (e = t.match(/windows ([^\)]*)/))),
            e && e[1] && (n = e[1].replace(/_/g, '.'))
          var a =
            this._appInfo && this._appInfo.build ? this._appInfo.build : '0.0.0'
    ...
    ve = (function() {
      ...
      return (
        (PlayActivityStub.prototype.activate = function(e) {
          return (
            void 0 === e && (e = !1),
            __awaiter(this, void 0, void 0, function() {
    ...
    Pe = (function() {
      return function(e) {
        ...
        var t = e.toLowerCase()
        ;(this.isEdge = /\sedge\//.test(t)),
          (this.isChrome = !this.isEdge && /chrome/.test(t)),
          (this.isSafari = !this.isEdge && !this.isChrome && /safari/.test(t)),
          (this.isFirefox =
            !this.isEdge &&
            !this.isChrome &&
            !this.isSafari &&
          ...
          (this.isIE =
            ...
            !this.isFirefox &&
            /trident|msie/.test(t)),
          (this.isMobile = /mobile/.test(t)),
          (this.isAndroid = this.isMobile && /android/.test(t)),
          (this.isiOS = this.isMobile && /iphone|ipad|ipod/.test(t)),
          (this.isWebView = /(webview|(iphone|ipod|ipad)(?!.*safari\/)|android.*(wv|\.0\.0\.0)|\bfb[\w_]+\/(?:messenger)?|\binstagram|\btwitter)/.test(
            t
          )),
          this.isEdge
            ? (this.engineVersion = t.match(/(?:edge).(\d+)/))
            : ((this.version = t.match(
                /(?:chrome|version|firefox|msie|rv).(\d+)\.(\d+)/
              )),
              (this.engineVersion = t.match(
    ...
    we = 'explicit',
    Se = 'audio/mp4;codecs="mp4a.40.2"',
    ke = {
      app: {},
      browser: function() {
        return _e || (_e = new Pe()), _e
      },
      features: { equivalencies: !0 },
      logger: new Y(),
      ...
      function memoize(e) {
        return function() {
          ...
          for (var i = '', n = t.length; n--; ) {
            var o = t[n]
            ;(i += o === Object(o) ? JSON.stringify(o) : o),
              e._memoized || (e._memoized = {})
          }
          return i in e._memoized
            ? e._memoized[i]
            : (e._memoized[i] = e.apply(void 0, t))
        }
      }
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.generateUUID = function() {
        ...
        (t.isNodeEnvironment = isNodeEnvironment),
        (t.atob = memoize(function(e) {
          return isNodeEnvironment()
            ? Buffer.from(e, 'base64').toString('ascii')
            : window.atob(e)
        })),
        ...
        (t.memoize = memoize),
        (t.urlEncodeParameters = function(e) {
          var t = ''
          return (
            e &&
              Object.keys(e).map(function(r, i, n) {
  ...
  Ie.generateUUID,
    Ie.isLibraryType,
    Ie.isNodeEnvironment,
    Ie.atob,
    Ie.btoa,
    Ie.memoize,
    Ie.urlEncodeParameters
    ...
    var r = (function() {
      function DeveloperToken(e) {
        if (
          ((this.token = e),
          !e ||
            !/^[a-z0-9\-\_]{16,}\.[a-z0-9\-\_]{16,}\.[a-z0-9\-\_]{16,}/i.test(
              e
            ))
        )
        ...
        var t = e.split('.'),
          ...
          o = n.exp,
          a = n.iss
        if (((this.expiration = 1e3 * o), this.isExpired))
      ...
      return (
        Object.defineProperty(DeveloperToken.prototype, 'isExpired', {
          get: function() {
  ...
  var De = createCommonjsModule(function(e, t) {
    ...
    ;(t.GenericStorage = r),
      ...
      (t.setCookie = function(e, t, r, i, n) {
        ...
        ;/^(?:[a-z\-]+\.)?(?:music|itunes)\.apple\.com$/i.test(a) &&
          (a = 'apple.com')
  ...
  unwrapExports(De)
  De.GenericStorage, De.getCookie, De.setCookie
  var Re = createCommonjsModule(function(e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.parseQueryParams = function(e) {
        return e
          ? (-1 !== e.indexOf('?') &&
              (e = e.substr(e.indexOf('?')).replace('?', '')),
            e.split('&').reduce(function(e, t) {
              var r = t.split('='),
                i = r[0],
                n = r[1]
              return (
                (e[i] = n ? decodeURIComponent(n.replace(/\+/g, ' ')) : ''), e
              )
            }, {}))
          : {}
      })
  ...
  unwrapExports(Re)
  Re.Defaults, Re.buildQueryParams
  var Oe = Re.parseQueryParams,
    Me = createCommonjsModule(function(e, t) {
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.arrayBufferToString = Ie.memoize(function(e) {
          for (
            var t = new Uint16Array(e), r = t.length, i = '', n = 0;
            n < r;
            n++
          )
        ...
        (t.base64ToUint8Array = Ie.memoize(function(e) {
          var r = Ie.atob(e)
        ...
        (t.stringToUint8Array = Ie.memoize(function(e) {
          for (
            var t = e.length,
              r = new ArrayBuffer(t),
              i = new Uint8Array(r),
        ...
        (t.stringToUint16Array = Ie.memoize(function(e) {
          for (
            var t = e.length,
              r = new ArrayBuffer(2 * t),
              i = new Uint16Array(r),
              n = 0;
            n < t;
            n++
        ...
        (t.uint8ArrayToBase64 = Ie.memoize(function(e) {
          for (
            var t,
              r,
              i,
            ...
            (n = (t = e[u++]) >> 2),
              (o =
                ((3 & t) << 4) |
                ((r = u < e.length ? e[u++] : Number.NaN) >> 4)),
              (a =
                ((15 & r) << 2) |
                ((i = u < e.length ? e[u++] : Number.NaN) >> 6)),
              (s = 63 & i),
              isNaN(r) ? (a = s = 64) : isNaN(i) && (s = 64),
              (l += c.charAt(n) + c.charAt(o) + c.charAt(a) + c.charAt(s))
          return l
        }))
    })
  unwrapExports(Me)
  Me.arrayBufferToString,
    Me.base64ToUint8Array,
    Me.ensureArray,
    Me.stringToUint8Array,
    Me.stringToUint16Array,
    Me.uint8ArrayToBase64
        ...
        function Dispatch(e) {
          ...
          void 0 === e && (e = {}),
            ...
            (this.handle = function(e) {
              e.data &&
                e.data.jsonrpc === s &&
                ((t.origin !== a && t.origin !== e.origin) ||
                  (e.data.method && t.destination
                    ? t.handleRequest(e.data).then(function(e) {
                        t.send(t.destination, e)
                      })
                    : (e.data.hasOwnProperty('result') || e.data.error) &&
                      t.handleResponse(e.data)))
            }),
            (this.destination = e.destination),
            (this.methods = e.methods || {}),
            (this.origin = e.origin || a),
            e.source && (this.source = e.source)
        }
        return (
          Object.defineProperty(Dispatch.prototype, 'source', {
            get: function() {
              return this._source
            },
            set: function(e) {
          ...
          (Dispatch.prototype.apply = function(e, t) {
            ...
            var i = this._sequence++,
              n = new Promise(function(e, t) {
                r._registry[i] = { resolve: e, reject: t }
              })
            return (
              ...
              return o(this, function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    return (
                      o.trys.push([1, 3, , 4]),
                      [4, r.apply(null, Me.ensureArray(e.params))]
                    )
                  case 2:
                    return (n = o.sent()), [2, Object.assign(t, { result: n })]
                  case 3:
                    return (
                      (a = o.sent()),
                      [
          ...
          (Dispatch.prototype.handleResponse = function(e) {
            ...
            delete this._registry[e.id],
              t &&
                (e.error
                  ? t.reject(Object.assign(Error(), e.error))
                  : t.resolve(e.result))
          }),
  ...
  var Ne = createCommonjsModule(function(e, r) {
    ...
    Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      })((i = r.AuthorizationStatus || (r.AuthorizationStatus = {}))),
      (r.validateToken = validateToken),
      (r.ACTIVATE_REQUEST_URL = 'https://activate.apple.com/mkauth'),
      (r.AUTHENTICATE_REQUEST_URL =
        'https://buy.itunes.apple.com/commerce/account/authenticateMusicKitRequest'),
      (r.SERVICE_URL = 'https://authorize.music.apple.com'),
      (r.SUBSCRIBE_URL = r.SERVICE_URL + '/upsell'),
    ...
    var u = (function() {
      ...
      return (
        Object.defineProperty(ServiceSetupView.prototype, 'isServiceView', {
          get: function() {
        ...
        (ServiceSetupView.prototype.load = function(e) {
          return (
            void 0 === e && (e = { action: n.AUTHORIZE }),
            a(this, void 0, void 0, function() {
              return s(this, function(t) {
                return e.action === n.SUBSCRIBE
                  ? [2, this._subscribeAction(e.parameters)]
                  : [2, this._authorizeAction(e.parameters)]
              })
            })
          )
        }),
        (ServiceSetupView.prototype.present = function(e, t) {
          ...
          var r = this._calculateClientDimensions(),
            ...
            c = o(
              {},
              u,
              { left: s / 2 - u.width / 2 + n, top: i / 2 - u.height / 2 + a },
              t
            ),
            l = Object.keys(c)
              .map(function(e) {
          ...
          return (
            /trident|msie/i.test(navigator.userAgent)
              ? ((this._window =
                  window.open(window.location.href, this.target, l) || void 0),
              ...
              return s(this, function(a) {
                return (
                  'GET' === this.authenticateMethod
                    ...
                    : ((t = this._buildFormElement(r.AUTHENTICATE_REQUEST_URL)),
                      document.body.appendChild(t)),
                  [
                    2,
                    new Promise(function(a, s) {
                      var u = o.present(n)
                      ;(o.dispatch = new Le.Dispatch({
                        methods: {
                          ...
                          thirdPartyInfo: function() {
                            return o._thirdPartyInfo(
                              o.developerToken,
                              Object.assign(o.deeplinkParameters, e)
                            )
                          },
        ...
        (ServiceSetupView.prototype._buildFormElement = function(e, t, r) {
          void 0 === t && (t = this.target),
            void 0 === r && (r = this.developerToken)
          ...
          n.setAttribute('name', 'jwtToken'),
            n.setAttribute('value', r),
            i.appendChild(n)
          var o = document.createElement('input')
          o.setAttribute('name', 'isWebPlayer'),
            o.setAttribute('value', 'true'),
            i.appendChild(o)
          var a = document.createElement('input')
          return (
            a.setAttribute('name', 'LogoURL'),
                ...
                return (
                  ...
                  [
                    ...
                    new Promise(function(i, n) {
                      var o = r.SUBSCRIBE_URL + '?' + Re.buildQueryParams(e)
                      t.present(o),
                        window.addEventListener('message', function(e) {
                          ...
                          ;(o && !r.WHITELIST_DOMAIN_REGEX.test(o)) ||
                            (s
                              ? 0 === s.supported
  ...
  Ne.AuthorizationStatus,
    Ne.validateToken,
    Ne.ACTIVATE_REQUEST_URL,
    Ne.AUTHENTICATE_REQUEST_URL,
    Ne.SERVICE_URL,
    Ne.SUBSCRIBE_URL,
    Ne.WHITELIST_DOMAIN_REGEX,
    Ne.ServiceSetupAction,
    Ne.ServiceSetupView
  var je = createCommonjsModule(function(e, r) {
    ...
    function fetchStorefronts(e, t) {
      return (
        void 0 === t && (t = 'https://api.music.apple.com/v1'),
        i(this, void 0, void 0, function() {
          ...
          return n(this, function(n) {
            switch (n.label) {
              case 0:
                return (
                  (r = new Headers({ Authorization: 'Bearer ' + e })),
                  [4, fetch(t + '/storefronts', { headers: r })]
                )
              case 1:
                return [4, n.sent().json()]
              case 2:
                return (i = n.sent()).errors
                  ? [2, Promise.reject(i.errors)]
                  : [2, i.data]
            }
          })
        })
    ...
    Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      (r.fetchStorefronts = fetchStorefronts)
    var o = (function() {
      function Storefront(e, t, r) {
        ;(this.id = e),
          (this.attributes = t),
          (this.type = 'storefronts'),
          (this.href = r || '/v1/' + this.type + '/' + e)
      }
      return (
        (Storefront.inferFromLanguages = function(e, t) {
          return (
            void 0 === t &&
  ...
  var Ue = je.Defaults,
    xe =
      (je.fetchStorefronts,
      je.Storefront,
      createCommonjsModule(function(e, r) {
        var i,
          n,
          o =
            (t && t.__extends) ||
        ...
        Object.defineProperty(r, '__esModule', { value: !0 }),
          (r.validateToken = Ne.validateToken),
          (r.AuthorizationStatus = Ne.AuthorizationStatus),
          (function(e) {
            ;(e.authorizationStatusDidChange = 'authorizationStatusDidChange'),
              (e.authorizationStatusWillChange =
                'authorizationStatusWillChange'),
              (e.eligibleForSubscribeView = 'eligibleForSubscribeView'),
              (e.storefrontCountryCodeDidChange =
                'storefrontCountryCodeDidChange'),
              (e.storefrontIdentifierDidChange =
        ...
        var u = (function(e) {
          function StoreKit(t, r) {
            var i =
              e.call(this, [
                n.authorizationStatusDidChange,
                n.authorizationStatusWillChange,
                n.eligibleForSubscribeView,
                n.storefrontCountryCodeDidChange,
                n.userTokenDidChange
              ]) || this
            return (
              (i.developerToken = t),
              (i.apiBase = 'https://api.music.apple.com/v1'),
              (i.persist = 'localstorage'),
              (i.playBase =
                'https://play.itunes.apple.com/WebObjects/MZPlay.woa/wa'),
              (i.prefix = 'music'),
              (i.storage = window.localStorage),
              (i._authorizationStatus = Ne.AuthorizationStatus.NOT_DETERMINED),
              (i._dispatchedSubscribeView = !1),
              r &&
                (r.deeplink && (i.deeplinkParameters = r.deeplink),
                r.persist && (i.persist = r.persist),
                r.prefix && (i.prefix = r.prefix)),
              (i._developerToken = new Ae.DeveloperToken(t)),
              (i._serviceSetupView = new Ne.ServiceSetupView(t, {
              ...
              (i.storagePrefix = (
                i.prefix +
                '.' +
                i._developerToken.teamId
              ).toLocaleLowerCase()),
              i.userTokenIsValid &&
                ((i._restrictedEnabled = i.restrictedEnabled),
                (i._authorizationStatus = i.restrictedEnabled
                  ? Ne.AuthorizationStatus.RESTRICTED
                  : Ne.AuthorizationStatus.AUTHORIZED)),
              (i._storefrontCountryCode = i.storefrontCountryCode),
              Ie.isNodeEnvironment() ||
                i._processLocationHash(window.location.hash),
              i
            )
          }
          return (
            o(StoreKit, e),
            Object.defineProperty(StoreKit.prototype, 'authorizationStatus', {
              get: function() {
              ...
              set: function(e) {
                this.dispatchEvent(n.authorizationStatusWillChange, {
                  ...
                  this.dispatchEvent(n.authorizationStatusDidChange, {
            ...
            Object.defineProperty(StoreKit.prototype, 'cid', {
              ...
              set: function(e) {
                e
                  ? this._setStorageItem(this.storagePrefix + '.c', e)
                  : this._removeStorageItem(this.storagePrefix + '.c'),
                  (this._cid = e)
              },
              enumerable: !0,
              configurable: !0
            ...
            Object.defineProperty(StoreKit.prototype, 'hasAuthorized', {
              get: function() {
                return this.authorizationStatus > Ne.AuthorizationStatus.DENIED
              },
              enumerable: !0,
              configurable: !0
            }),
            Object.defineProperty(StoreKit.prototype, 'restrictedEnabled', {
              get: function() {
                if (
                  this.userToken &&
                  'boolean' != typeof this._restrictedEnabled
                ) {
              ...
              set: function(e) {
                this.userToken &&
                  void 0 !== e &&
                  this._setStorageItem(this.userToken + '.r', e ? '1' : '0'),
            ...
            Object.defineProperty(StoreKit.prototype, 'storefrontCountryCode', {
              get: function() {
                if (!this._storefrontCountryCode) {
                  ...
                  this._storefrontCountryCode = e || je.Defaults.ID
                }
                return this._storefrontCountryCode
              },
              set: function(e) {
                e && this.userToken
                  ? this._setStorageItem(this.userToken + '.s', e)
                  : this._removeStorageItem(this.userToken + '.s'),
                  (this._storefrontCountryCode = e),
                  this.dispatchEvent(n.storefrontCountryCodeDidChange, {
            ...
            Object.defineProperty(StoreKit.prototype, 'storefrontIdentifier', {
              ...
              set: function(e) {
                ;(this._storefrontIdentifier = e),
                  this.dispatchEvent(n.storefrontIdentifierDidChange, {
            ...
            Object.defineProperty(StoreKit.prototype, 'userToken', {
              ...
              set: function(e) {
                e && Ne.validateToken(e)
                  ? ((this.authorizationStatus = this.restrictedEnabled
                      ? Ne.AuthorizationStatus.RESTRICTED
                      : Ne.AuthorizationStatus.AUTHORIZED),
                    this._setStorageItem(this.storagePrefix + '.u', e))
                  : ((this.authorizationStatus =
                      Ne.AuthorizationStatus.NOT_DETERMINED),
                    this._removeStorageItem(this.storagePrefix + '.u')),
                  (this._userToken = e),
                  this.dispatchEvent(n.userTokenDidChange, { userToken: e })
              },
              enumerable: !0,
              configurable: !0
            }),
            Object.defineProperty(StoreKit.prototype, 'userTokenIsValid', {
              get: function() {
                return Ne.validateToken(this.userToken)
              },
              enumerable: !0,
              configurable: !0
            }),
            (StoreKit.prototype.deeplinkURL = function(e) {
              return (
                void 0 === e && (e = {}),
                (e = Object.assign(this.deeplinkParameters || {}, e)),
                'https://finance-app.itunes.apple.com/deeplink?' +
                  Re.buildQueryParams(e)
              )
            }),
            (StoreKit.prototype.itunesDeeplinkURL = function(e) {
              return (
                void 0 === e && (e = { p: 'browse' }),
                (e = Object.assign(this.deeplinkParameters || {}, e)),
                'https://itunes.apple.com/deeplink?' + Re.buildQueryParams(e)
              )
            }),
              ...
              return a(this, void 0, void 0, function() {
                ...
                return s(this, function(i) {
                  switch (i.label) {
                    case 0:
                      return this.userToken
                        ? ((e = new Headers({
                          ...
                          [
                            4,
                            fetch(this.playBase + '/renewMusicToken', {
                              method: 'POST',
                              headers: e
                            })
                          ])
                    ...
                    case 1:
                      return 401 !== (t = i.sent()).status
                        ? [3, 3]
                        : [4, this.revokeUserToken()]
                    case 2:
                      return (
                        i.sent(), [2, Promise.reject(new Error('Renew token'))]
                      )
                    case 3:
                      return [4, t.json()]
                    case 4:
                      return (
                        (r = i.sent())['music-token'] &&
                          (this.userToken = r['music-token']),
                        [2, this.userToken]
                      )
                  }
                })
                  ...
                  switch (n.label) {
                    case 0:
                      return this.authorizationStatus <=
                        Ne.AuthorizationStatus.DENIED
                        ? [
                            2,
                            Promise.reject(
                              'Not authorized: ' + this.authorizationStatus
                            )
                          ]
                        : ((e = new Headers({
                            Authorization: 'Bearer ' + this.developerToken,
                          ...
                          [
                            4,
                            fetch(this.apiBase + '/me/storefront', {
                              headers: e
                            })
                          ])
                    case 1:
                      return (t = n.sent()).ok
                        ? [4, t.json()]
                        : (this._reset(),
                          [2, Promise.reject('Storefront Country Code error.')])
                    case 2:
                      return (r = n.sent()).errors
                        ? [2, Promise.reject(r.errors)]
                        : (i = r.data[0]) && i.id
                        ? ((this.storefrontCountryCode = i.id),
                          [2, this.storefrontCountryCode])
                        : [2, Promise.reject('Storefront Country Code error.')]
                  }
                })
              })
                  ...
                  switch (t.label) {
                    case 0:
                      return this.storefrontIdentifier
                        ...
                        : [
                            4,
                            je.Storefront.inferFromLanguages(
                              this.developerToken
                            )
                          ]
                    case 1:
                  ...
                  switch (r.label) {
                    ...
                    case 1:
                      return (
                        ...
                        [
                          4,
                          this._serviceSetupView.load({
                            action: Ne.ServiceSetupAction.AUTHORIZE
                          })
                        ]
                      )
                    case 2:
              ...
              return a(this, void 0, void 0, function() {
                return s(this, function(e) {
                  switch (e.label) {
                    case 0:
                      return (
                        e.trys.push([0, 2, , 3]), [4, this._webPlayerLogout()]
                      )
                    case 1:
                      return e.sent(), [3, 3]
                    case 2:
                ...
                a(this, void 0, void 0, function() {
                  ...
                  return s(this, function(r) {
                    switch (r.label) {
                      case 0:
                        if (
                          this._serviceSetupView.isServiceView ||
                          !this.eligibleForSubscribeView
                        )
                          return [2]
                        if (!e)
                          return (
                            this.dispatchEvent(n.eligibleForSubscribeView),
                            (this._dispatchedSubscribeView = !0),
                            [2]
                          )
                        r.label = 1
                      case 1:
                        return (
                          ...
                          [
                            4,
                            this._serviceSetupView.load({
                              action: Ne.ServiceSetupAction.SUBSCRIBE
                            })
                          ]
                        )
                      case 2:
                      ...
                      return this.authorizationStatus <=
                        ...
                        : ((e = new Headers({
                          ...
                          [
                            4,
                            fetch(
                              this.apiBase + '/me/account?meta=subscription',
                              { headers: e }
                            )
                          ])
                    case 1:
                      return (t = n.sent()).ok
                        ? [4, t.json()]
                        : (this._reset(), [2, Promise.reject('Account error.')])
                    case 2:
                      return (r = n.sent()).errors
                        ? [2, Promise.reject(r.errors)]
                        : (i = r.meta) && i.subscription
                        ? ((this.storefrontCountryCode =
                            i.subscription.storefront),
                          [2, i.subscription])
                        : [2, Promise.reject('Account error.')]
                  }
                })
              })
            }),
            ...
            (StoreKit.prototype._removeStorageItem = function(e) {
              return 'cookie' === this.persist
                ? De.setCookie(btoa(e), '', '/', 0)
                : 'localstorage' === this.persist
                ? this.storage.removeItem(e)
                : void 0
            }),
            (StoreKit.prototype._reset = function(e) {
              void 0 === e && (e = Ne.AuthorizationStatus.NOT_DETERMINED),
                (this._authorizationStatus = e),
                (this._cid = void 0),
                ...
                this._removeStorageItem(this.storagePrefix + '.c'),
                this._removeStorageItem(this._userToken + '.r'),
                this._removeStorageItem(this.storagePrefix + '.u'),
                this._removeStorageItem(this._userToken + '.s'),
                (this._userToken = void 0)
            }),
            (StoreKit.prototype._setStorageItem = function(e, t) {
              return 'cookie' === this.persist
                ? De.setCookie(btoa(e), t, '/', 180)
                : 'localstorage' === this.persist
                  ...
                  switch (r.label) {
                    case 0:
                      return (
                        ...
                        [
                          4,
                          fetch(this.playBase + '/webPlayerLogout', {
                            method: 'POST',
                            headers: e
                          })
                        ]
  ...
  unwrapExports(xe)
  xe.validateToken
  var Be = xe.AuthorizationStatus,
    ze = xe.StoreKitNotifications,
    Ke = xe.StoreKit,
    Ve = {
  ...
  unwrapExports(qe)
  qe.DeveloperToken
  var Fe = createCommonjsModule(function(e, r) {
    var i,
      n =
        (t && t.__extends) ||
        ((i =
    ...
    var u = (function() {
      function URLSession(e, t, r) {
        ;(this.headers = new Headers()),
          ...
          (this.method = 'GET'),
          (this.url = e),
          (this.storage = t || new ae.GenericStorage()),
          (this.ttl = r || 3e5)
      }
      return (
        (URLSession.prototype.request = function(e, t, r) {
          return a(this, void 0, void 0, function() {
            var i, n, a, u, c, l, d
              ...
              switch (s.label) {
                case 0:
                  return (
                    r ||
                      'object' != typeof e ||
                      ((r = t || {}), (t = e), (e = void 0)),
                    (r = o({ method: this.method, headers: this.headers }, r)),
                    (i = e ? this.url + '/' + e : this.url),
                    (n = r.method),
                    t &&
                      'GET' === n &&
                      ((a = Object.keys(t)
                ...
                case 1:
                  return (c = s.sent()).ok
                    ...
                    : [2, Promise.reject(c)]
                case 2:
                  return (l = s.sent()).errors
                    ? [2, Promise.reject(l.errors)]
                    : ((d = l.results || l.data || l),
                      this.setCacheItem(i, d),
                      [2, d])
              }
            })
          })
        ...
        (URLSession.prototype.clearCacheItems = function() {
          var e = this,
            t =
              this.storage.constructor === ae.GenericStorage
                ? this.storage._data
                : this.storage
          Object.keys(t)
            .filter(function(t) {
        ...
        (URLSession.prototype.setCacheItem = function(e, t, r) {
          ...
          this.storage.removeItem(i),
            this.storage.setItem(i, JSON.stringify({ x: Date.now() + r, d: t }))
        }),
        (URLSession.prototype._key = function(e) {
          var t = e.toLowerCase().replace(this.url, ''),
            r = this.headers.get('Music-User-Token')
          return (
            r && (t = '' + r.replace(/[^0-9a-z]{1,}/g, '') + t),
            '' + this.prefix + t.replace(/[^-_0-9a-z]{1,}/g, '.')
          )
        }),
        URLSession
      )
    ...
    var c = (function(e) {
      function TokenSession(t, r, i, n) {
        ...
        return (
          (o._developerToken = new qe.DeveloperToken(r)),
          o.headers.append('Authorization', 'Bearer ' + o.developerToken),
          (o.userToken = i),
          o.userToken && o.headers.append('Music-User-Token', o.userToken),
          o
        )
      }
      return (
        n(TokenSession, e),
        Object.defineProperty(TokenSession.prototype, 'developerToken', {
          get: function() {
        ...
        (t.transform = function(e, t) {
          return Object.keys(e).reduce(function(r, i) {
            var n,
              o = e[i]
            return (
              (n = 'function' == typeof o ? o() : get(t, o)) && set(r, i, n), r
            )
          }, {})
        })
    })
  ...
  var Qe = createCommonjsModule(function(e, t) {
    function stringToUint8Array(e) {
      for (
        var t = e.length, r = new ArrayBuffer(t), i = new Uint8Array(r), n = 0;
        n < t;
        n++
      )
        i[n] = e.charCodeAt(n)
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.stringToUint8Array = stringToUint8Array),
      (t.stringToUint16Array = function(e) {
        for (
          var t = e.length,
            r = new ArrayBuffer(2 * t),
            i = new Uint16Array(r),
      ...
      (t.uint8ArrayToBase64 = function(e) {
        for (
          ...
          (n = (t = e[u++]) >> 2),
            (o =
              ((3 & t) << 4) | ((r = u < e.length ? e[u++] : Number.NaN) >> 4)),
            (a =
              ((15 & r) << 2) |
              ((i = u < e.length ? e[u++] : Number.NaN) >> 6)),
            (s = 63 & i),
  ...
  unwrapExports(Qe)
  var $e = Qe.arrayBufferToString,
    Ze = Qe.base64ToUint8Array,
    Xe = (Qe.ensureArray, Qe.stringToUint8Array, Qe.stringToUint16Array),
    Je = Qe.uint8ArrayToBase64,
    et = createCommonjsModule(function(e, t) {
      Object.defineProperty(t, '__esModule', { value: !0 })
      var r = (function() {
        ...
        return (
          (DataRecord.prototype.hasAttributes = function(e) {
            if (!e) return this._attributes.length > 0
            e = Qe.ensureArray(e)
            for (
              var t = !1, r = 0;
              r < e.length && (t = this._attributes.indexOf(e[r]) > -1);
              r++
            );
            return t
          }),
          (DataRecord.prototype.serialize = function(e) {
            var t = this
            void 0 === e && (e = !0)
            var r = { id: this.id, type: this.type }
            return (
              this.hasAttributes() &&
                (r.attributes = this._attributes.reduce(function(e, r) {
                  return (e[r] = t[r]), e
                }, {})),
              this._relationships.length > 0 &&
                (r.relationships = this._relationships.reduce(function(e, r) {
                  var i = t[r]
                  return (
                    Array.isArray(i)
                      ? (e[r] = {
                          data: i.map(function(e) {
                            return 'function' == typeof e.serialize
                              ? e.serialize(!1)
                              : e
                          })
                        })
                      : (e[r] =
                          'function' == typeof i.serialize ? i.serialize() : i),
                    e
                  )
                }, {})),
              e ? { data: r } : r
          ...
          (DataRecord.prototype.setProperty = function(e, t, r) {
            void 0 === r && (r = 'attributes'),
              this.hasOwnProperty(e) || this['_' + r].push(e),
              (this[e] = t)
          }),
          DataRecord
        )
        ...
        return (
          ...
          (DataStore.prototype.peek = function(e, t) {
            ...
            return 'string' != typeof t
              ? !t && this._records[e]
                ? Object.values(this._records[e])
                : Array.isArray(t) && this._records[e]
                ? t.map(function(t) {
                    return r._records[e][t]
                  })
                : []
              : this._records[e] && this._records[e][t]
              ? this._records[e][t]
              : null
          }),
          (DataStore.prototype.populateDataRecords = function(e, t, r) {
            ...
            return (
              void 0 === t && (t = {}),
              void 0 === r && (r = this.mapping),
              Qe.ensureArray(e.data).map(function(e) {
                var n = i._materializeRecord(e.type, e.id, t)
                return (
                  r && Object.assign(e, We.transform(r, e)),
                  e.attributes
                    ? (Object.keys(e.attributes).forEach(function(t) {
                        n.setProperty(t, e.attributes[t], 'attributes')
                      }),
                      e.relationships &&
                        Object.keys(e.relationships).forEach(function(o) {
                          if (e.relationships[o].data) {
                            var a = i.populateDataRecords(
                              e.relationships[o],
                              t,
                              r
                            )
          ...
          (DataStore.prototype.save = function(e, t) {
            return (
              void 0 === t && (t = this.mapping),
              this.populateDataRecords(e, this._records, t)
            )
          }),
          (DataStore.prototype._materializeRecord = function(e, t, i) {
            return (
              (i[e] = i[e] || {}), (i[e][t] = i[e][t] || new r(e, t)), i[e][t]
            )
          }),
          DataStore
        )
  ...
  var tt,
    ...
    it = (function() {
      function LocalDataStore() {
        ;(this.enableDataStore = !!ke.features['api-data-store']),
          this.enableDataStore && (this._store = new rt())
      }
      return (
        Object.defineProperty(LocalDataStore.prototype, 'hasDataStore', {
          get: function() {
    ...
    ot = (function(e) {
      function Library(t, r, i) {
        ...
        return (n._last = 0), (n._store = new it()), n
      }
      return (
        __extends(Library, e),
        (Library.prototype.add = function(e) {
          return __awaiter(this, void 0, void 0, function() {
            var t, r, i, n
            return __generator(this, function(o) {
              switch (o.label) {
                case 0:
                  if ((t = Date.now()) - this._last < 1e3)
                    return [2, Promise.reject(new re(re.QUOTA_EXCEEDED))]
                  ;(r = new Headers({
                    Authorization: 'Bearer ' + this.developerToken,
                    'Music-User-Token': this.userToken
                  })),
                ...
                case 3:
                  return (
                    (n = o.sent()), [2, Promise.reject(re.responseError(n))]
                  )
                case 4:
                  return [2]
              }
        ...
        (Library.prototype.playlist = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = Object.assign({ include: 'tracks' }, t)),
                [2, this.resource('playlists', e, t)]
              )
            })
          })
        }),
          ...
          return (
            ...
            __awaiter(this, void 0, void 0, function() {
              return __generator(this, function(i) {
                return [
                  2,
                  this.collection('playlists/' + e + '/' + t, void 0, r)
                ]
              })
            })
          )
        ...
        (Library.prototype.search = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return (
                (t = this._denormalizeLibraryTypes(t)),
                (r = Object.assign({ term: e, types: 'library-albums' }, t)),
                [2, this.collection('search', void 0, r, !1)]
              )
            })
          })
        }),
                ...
                switch (s.label) {
                  case 0:
                    !t ||
                      t.length ||
                      r ||
                      ((r = transformParameters(t, 100)), (t = void 0)),
                      (o = t ? Object.assign({ ids: t.join(',') }, r) : r),
                      (s.label = 1)
                  case 1:
                    return (
                      s.trys.push([1, 3, , 4]),
                      [4, this.request(nt + '/' + e, o)]
                    )
                  case 2:
                    return (n = s.sent()), [3, 4]
                  case 3:
                    return (
                      (a = s.sent()), [2, Promise.reject(re.responseError(a))]
                    )
                  case 4:
                    try {
                      return [
                        2,
                        i ? this._store.write(n) : this._store.parse(n)
                      ]
                    } catch (e) {
                      return [2, Promise.reject(re.parseError(e))]
                    }
                    return [2]
                }
              })
                    ...
                    return __generator(this, function(o) {
                      switch (o.label) {
                        ...
                        case 2:
                          return (
                            (n = o.sent()),
                            [2, Promise.reject(re.responseError(n))]
                          )
                        case 3:
                          try {
  ...
  function formatArtworkURL(e, t, r) {
    return (
      (t = t || e.height || 100),
      (r = r || e.width || 100),
      window.devicePixelRatio >= 1.5 && ((r *= 2), (t *= 2)),
      e.url
        .replace('{h}', '' + t)
        .replace('{w}', '' + r)
        .replace('{f}', 'jpeg')
  ...
  var at = ['search/hints', 'recommendations'],
    st = (function(e) {
      function API(t, r, i, n, o, a) {
        var s = e.call(this, t, r, n, a) || this
        return (
          (s.storefrontId = Ue.ID),
          (s.enablePlayEquivalencies = !!ke.features.equivalencies),
          (s.resourceRelatives = {
            artists: {
          ...
          (s._store = new it()),
          i && (s.storefrontId = i),
          n && o && (s.userStorefrontId = o),
          (s.library = new ot(t, r, n)),
          s
        )
      }
      return (
        ...
        Object.defineProperty(API.prototype, 'needsEquivalents', {
          get: function() {
            return (
              this.userStorefrontId &&
              this.userStorefrontId !== this.storefrontId
            )
          },
          enumerable: !0,
          configurable: !0
        ...
        (API.prototype.activity = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Catalog, 'activities', e, t)]
            })
          })
        }),
        (API.prototype.activities = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'activities', e, t)]
            })
          })
        }),
        (API.prototype.album = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t, 'extend[songs]')),
                [2, this.resource(tt.Catalog, 'albums', e, t)]
              )
            })
          })
        }),
        (API.prototype.albumRelationship = function(e, t, r) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(i) {
              return [
                2,
                this.collection(tt.Catalog, 'albums/' + e + '/' + t, void 0, r)
              ]
            })
          })
        }),
        (API.prototype.albums = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t, 'extend[songs]')),
                [2, this.collection(tt.Catalog, 'albums', e, t)]
              )
            })
          })
        }),
        (API.prototype.appleCurator = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Catalog, 'apple-curators', e, t)]
            })
          })
        }),
        (API.prototype.appleCurators = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'apple-curators', e, t)]
            })
          })
        }),
        (API.prototype.artist = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            var r
            return __generator(this, function(i) {
              return !!!ke.features['api-artist-include'] &&
                t &&
                t.hasOwnProperty('include') &&
                this.resourceRelatives.artists.hasOwnProperty(t.include)
                ? ((r = t.include),
                  delete t.include,
                  (t = Object.assign(
                    t,
                    this.resourceRelatives.artists[r] || {}
                  )),
                  [
                    2,
                    this.collection(
                ...
                : [2, this.resource(tt.Catalog, 'artists', e, t)]
            })
          })
        }),
        (API.prototype.artistRelationship = function(e, t, r) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(i) {
              return [
                2,
                this.collection(tt.Catalog, 'artists/' + e + '/' + t, void 0, r)
              ]
            })
          })
        }),
        (API.prototype.artists = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'artists', e, t)]
            })
          })
        }),
        (API.prototype.charts = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'charts', e, t)]
            })
          })
        }),
        (API.prototype.curator = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Catalog, 'curators', e, t)]
            })
          })
        }),
        (API.prototype.curators = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'curators', e, t)]
            })
          })
        }),
        (API.prototype.genre = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Catalog, 'genres', e, t)]
            })
          })
        }),
        (API.prototype.genres = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'genres', e, t)]
            })
          })
        }),
        ...
        (API.prototype.musicVideo = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t)),
                [2, this.resource(tt.Catalog, 'music-videos', e, t)]
              )
            })
          })
        }),
        (API.prototype.musicVideos = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t)),
                [2, this.collection(tt.Catalog, 'music-videos', e, t)]
              )
            })
          })
        }),
        (API.prototype.playlist = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Catalog, 'playlists', e, t)]
            })
          })
        }),
        ...
        (API.prototype.playlists = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'playlists', e, t)]
            })
          })
        }),
            ...
            return __generator(this, function(i) {
              switch (i.label) {
                case 0:
                  return [
                    4,
                    this.collection(tt.Personalized, 'recommendations', e, t)
                  ]
                case 1:
                  ;(r = i.sent()),
                    this._reindexRelationships(r, 'recommendations')
                  try {
        ...
        (API.prototype.search = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return (
                (r = Object.assign({ term: e }, transformParameters(t))),
                [2, this.collection(tt.Catalog, 'search', void 0, r)]
              )
            })
          })
        }),
        (API.prototype.searchHints = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return (
                (r = Object.assign({ term: e }, transformParameters(t))),
                [2, this.collection(tt.Catalog, 'search/hints', void 0, r)]
              )
            })
          })
        }),
        (API.prototype.song = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                (t = this.equivalentParameters(t)),
                [2, this.resource(tt.Catalog, 'songs', e, t)]
              )
            })
          })
        }),
        (API.prototype.songs = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return (
                !t && e && e.constructor === Object && ((t = e), (e = void 0)),
                (t = this.equivalentParameters(t)),
                [2, this.collection(tt.Catalog, 'songs', e, t)]
              )
            })
          })
        }),
        (API.prototype.station = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Catalog, 'stations', e, t)]
            })
          })
        }),
        (API.prototype.stations = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Catalog, 'stations', e, t)]
            })
          })
        }),
        (API.prototype.storefront = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.resource(tt.Global, 'storefronts', e, t)]
            })
          })
        }),
        (API.prototype.storefronts = function(e, t) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(r) {
              return [2, this.collection(tt.Global, 'storefronts', e, t)]
            })
          })
        }),
        (API.prototype.addToLibrary = function(e) {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(t) {
              return this.developerToken && this.userToken && this.library
                ? [2, this.library.add(e)]
                : [2, Promise.reject('Invalid tokens')]
            })
          })
        }),
                ...
                switch (d.label) {
                  case 0:
                    switch (
                      ...
                      case tt.Editorial:
                        ;(c = this.storefrontId),
                          this.needsEquivalents &&
                            'playlists' === t &&
                            (c = this.userStorefrontId),
                          (a = e + '/' + c + '/' + t)
                        break
                      case tt.Global:
                        a = t
                        break
                      case tt.Personalized:
                        ;(a = e + '/' + t), (n = !1)
                    }
                    d.label = 1
                  case 1:
                  ...
                  case 2:
                    return 0 === (s = d.sent()).length
                      ? [
                          2,
                          Promise.reject(
                            new re(
                              re.CONTENT_UNAVAILABLE,
                  ...
                  case 3:
                    return (
                      (l = d.sent()), [2, Promise.reject(re.responseError(l))]
                    )
                  case 4:
                    try {
                      return [
                        2,
                        n ? this._store.write(s) : this._store.parse(s)
                      ]
                    } catch (e) {
                      return [2, Promise.reject(re.parseError(e))]
                    }
        ...
        (API.prototype.equivalentParameters = function(e, t) {
          if (
            (void 0 === e && (e = {}),
            void 0 === t && (t = 'extend'),
            !this.needsEquivalents || !this.userStorefrontId)
          )
            return e
          var r = { equivalentStorefronts: this.userStorefrontId }
          return (
            this.enablePlayEquivalencies
              ? (r[t] = 'equivalentPlayParams')
              : (r.include = 'equivalents'),
            Object.assign(e, r)
          )
        }),
        (API.prototype._reindexRelationships = function(e, t) {
          e.forEach(function(e) {
            e.hasOwnProperty('relationships') &&
              e.relationships.hasOwnProperty(t) &&
              e.relationships[t].hasOwnProperty('data') &&
              Array.isArray(e.relationships[t].data) &&
              e.relationships[t].data.forEach(function(e, t) {
                e.id = e.id + '-' + t
              })
          })
        }),
    ...
    ut = createCommonjsModule(function(e, t) {
      Object.defineProperty(t, '__esModule', { value: !0 })
      var r = (function() {
        function Notifications(e) {
          void 0 === e && (e = [])
  ...
  !(function(e) {
    ...
    (function(e) {
      ;(e[(e.DEFAULT = 0)] = 'DEFAULT'),
        (e[(e.PREVIEW_ONLY = 1)] = 'PREVIEW_ONLY')
    })(ct || (ct = {})),
    (function(e) {
  ...
  var pt,
    ht = Ve.playbackBitrateDidChange,
    ft = Ve.playbackStateDidChange,
    yt = Ve.playbackStateWillChange,
    bt = Ve.playbackTargetAvailableDidChange,
    mt = (function(t) {
      function Playback(r) {
        void 0 === r && (r = [])
        var i = t.call(this, [ht, ft, yt, bt].concat(r)) || this
        return (
          (i._bitrate = e.PlaybackBitrate.STANDARD),
          (i._playbackState = e.PlaybackStates.none),
          (i._timingAccuracy = lt.ROUND),
          (i._downlinkSamples = []),
          (i._playbackTargetAvailable = !1),
          (i._mode = ct.DEFAULT),
          i
        )
      }
      return (
        __extends(Playback, t),
        Object.defineProperty(Playback.prototype, 'bitrate', {
          get: function() {
            return this._bitrate
          },
          set: function(e) {
            this._bitrate !== e &&
              ((this._bitrate = e), this.dispatchEvent(ht, { bitrate: e }))
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Playback.prototype, 'medianDownlink', {
          get: function() {
            return (
              this._downlinkSamples.reduce(function(e, t) {
                return e + t
        ...
        Object.defineProperty(Playback.prototype, 'playbackState', {
          ...
          set: function(e) {
            var t = { oldState: this._playbackState, state: e }
            this.dispatchEvent(yt, t),
              (this._playbackState = e),
              this.dispatchEvent(ft, t)
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Playback.prototype, 'playbackTargetAvailable', {
          ...
          set: function(e) {
            ;(this._playbackTargetAvailable = e),
              this.dispatchEvent(bt, { available: e })
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(Playback.prototype, 'previewOnly', {
          get: function() {
            return this._mode === ct.PREVIEW_ONLY
          },
          set: function(e) {
            this._mode = e ? ct.PREVIEW_ONLY : ct.DEFAULT
          },
          enumerable: !0,
          configurable: !0
        }),
        (Playback.prototype.timing = function(e) {
          return (
            void 0 === e && (e = 0),
            this._timingAccuracy === lt.ROUND ? Math.round(e) : e
          )
        }),
        (Playback.prototype.recalculateBitrate = function(t) {
          this._downlinkSamples.push(t),
            this.medianDownlink && this.medianDownlink >= 65
  ...
  var _t = Ve.mediaItemStateDidChange,
    gt = Ve.mediaItemStateWillChange,
    vt = (function(e) {
      function MediaItem(t) {
        void 0 === t && (t = {})
        var r = e.call(this, [_t, gt]) || this
        ;(r._assets = []), (r._isPlayable = !0), (r._state = pt.none)
        return (
          t.id && t.attributes
            ? (Object.assign(r, t),
              (r.type =
                r.playParams && r.playParams.kind
                  ? r.playParams.kind
                  : r.type || 'song'))
            : ((r.id = t.id || oe()),
              (r.type = t.type || 'song'),
              (r.attributes = { playParams: { id: r.id, kind: r.type } })),
          (r._isPlayable = -1 !== ke.supportedMediaTypes.indexOf(r.type)),
          t.container
            ? (r._container = t.container)
            : t.containerId &&
              t.containerType &&
              (r._container = { id: t.containerId, type: t.containerType }),
          r
        )
      }
      return (
        __extends(MediaItem, e),
        Object.defineProperty(MediaItem.prototype, 'albumInfo', {
          get: function() {
        ...
        Object.defineProperty(MediaItem.prototype, 'isPlayable', {
          get: function() {
            return 'song' === this.type
              ? this._isPlayable && (this.playParams || this.previewURL)
              : this._isPlayable && !!this.attributes.assetUrl
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(MediaItem.prototype, 'isPreparedToPlay', {
          get: function() {
            return 'song' === this.type
              ? !!this._assets && !!this.keyURLs && !!this._songId
              : !!this.assetURL ||
                  (this.playRawAssetURL && !!this.attributes.assetUrl)
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(MediaItem.prototype, 'isRestricted', {
          get: function() {
            return this.state === pt.restricted
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(MediaItem.prototype, 'isUnavailable', {
          get: function() {
            return this.state === pt.unavailable
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(MediaItem.prototype, 'previewURL', {
          get: function() {
            return Ge(this, 'attributes.previews.0.url')
          },
          enumerable: !0,
          configurable: !0
        }),
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(d) {
              switch (d.label) {
                case 0:
                  return e || t
                    ? this.isPreparedToPlay
                      ? [2]
                      : ((this.state = pt.loading),
                        'podcast-episodes' === this.type
                          ? ((this.assetURL = this.attributes.assetUrl), [2])
                          : [4, this._handleStorefrontEquivalency(r)])
                    : [
                        2,
                        Promise.reject(
                          new re(
                ...
                case 1:
                  return (
                    ...
                    (o = { salableAdamId: i }),
                    this.isCloudItem &&
                      (o = (a = /^a\.(\d+)$/).test(this.id)
                        ? {
                            subscriptionAdamId: parseInt(
                              i.replace(a, '$1'),
                              10
                            ),
                            isLibrary: !0
                          }
                        : { universalLibraryId: i, isLibrary: !0 }),
                    [
                      4,
                      fetch(ke.urls.play, {
                        method: 'POST',
                ...
                case 3:
                  if (((s = d.sent()), !(u = JSON.parse(s)) || !u.songList)) {
                    switch ((c = re.serverError(u)).errorCode) {
                      case re.CONTENT_RESTRICTED:
                        this.state = pt.restricted
                        break
                      case re.CONTENT_UNAVAILABLE:
                        this.state = pt.unavailable
                        break
                      default:
                        this.state = pt.error
                    }
                  ...
                  return (
                    (l = u.songList[0]),
                    (this._songId = l.songId),
                    (this._assets = l.assets),
                    (this.keyURLs = {
        ...
        (MediaItem.prototype.restrict = function() {
          this.isExplicitItem &&
            ((this.state = pt.restricted),
            (this._isPlayable = !1),
            this.playParams && delete this.attributes.playParams)
        }),
        (MediaItem.prototype._handleStorefrontEquivalency = function(e) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
              return e
                ? (this.attributes.equivalents
                    ? (t = this.attributes.equivalents[e]
                        .equivalentPlayParams) &&
                      (this.attributes.playParams = t)
                    : this.relationships &&
                      this.relationships.equivalents &&
                      this.relationships.equivalents.data &&
                      this.relationships.equivalents.data.length &&
                      (r = this.relationships.equivalents.data[0]).id !==
                        this.id &&
                      (this._equivalent = r),
                  [2])
                : [2]
  ...
  var Pt = Ve.queueItemsDidChange,
    wt = Ve.queuePositionDidChange,
    St = (function(e) {
      function Queue(t) {
        ...
        return (
          isNaN(i) || (r._position = i),
          r._reindex(),
          r._itemIDs.forEach(function(e, t) {
      ...
      return (
        ...
        Object.defineProperty(Queue.prototype, 'isRestricted', {
          ...
          set: function(e) {
            ;(this._isRestricted = e),
              this._isRestricted &&
                this._items &&
                (this._items = this._items.map(function(e) {
                  return e.restrict(), e
                }))
          },
          enumerable: !0,
        ...
        Object.defineProperty(Queue.prototype, 'nextPlayableItem', {
          get: function() {
            if (void 0 !== this.nextPlayableItemIndex)
        ...
        Object.defineProperty(Queue.prototype, 'position', {
          ...
          set: function(e) {
            if (e !== this._position) {
              var t = { oldPosition: this._position, position: e }
              ;(this._nextPlayableItemIndex = void 0),
                (this._previousPlayableItemIndex = void 0),
                (this._position = e),
                this.dispatchEvent(wt, t)
            }
          },
          enumerable: !0,
          configurable: !0
        ...
        (Queue.prototype.append = function(e) {
          var t,
            r,
            i = this._descriptorToMediaItems(e)
          ;(t = this._items).push.apply(t, i),
            (r = this._itemIDs).push.apply(
              r,
              i.map(function(e) {
                return e.id
              })
            ),
            this.dispatchEvent(Pt, this._items)
        }),
        ...
        (Queue.prototype.prepend = function(e, t) {
          ...
          t && ((this._items.length = o), (this._itemIDs.length = o)),
            (r = this._items).splice.apply(r, [o, 0].concat(n)),
            (i = this._itemIDs).splice.apply(
              i,
              [o, 0].concat(
                n.map(function(e) {
                  return e.id
        ...
        (Queue.prototype._descriptorToMediaItems = function(e) {
                ...
                : (r = o.map(function(e) {
                    return new vt(
                      (function(e) {
                        var t = Ye(
                          {
                            ...
                            'attributes.contentRating': function() {
                              if (1 === Ge(e, 'metadata.isExplicit')) return we
                            },
                            'attributes.playParams': function() {
                              return (
                                0 !== Ge(e, 'metadata.isPlayable') && {
                                  id: Ge(e, 'metadata.itemId'),
                                  kind: Ge(e, 'metadata.itemType')
                                }
                              )
                            },
                        ...
                        return Object.assign({ attributes: {} }, t)
                      })(e)
                    )
                  })),
              r
          ...
          return (
            isDataRecord(i)
              ? (r = this._dataRecordToMediaItems(i))
              : isMediaAPIResource(i) && (r = this._resourceToMediaItem(i)),
            r
          )
        }),
        (Queue.prototype._handleQueueReorder = function(e) {
          this._reindex(), e && this.dispatchEvent(Pt, this._items)
        }),
        ...
        (Queue.prototype._resourceToMediaItem = function(e) {
          if (
            e.relationships &&
            e.relationships.tracks &&
            e.relationships.tracks.data
          ) {
            var t,
              r =
                (void 0 === (n = e.relationships.tracks.data) && (n = []),
                0 !== n.length &&
                  n.filter(function(e) {
                    var t = e.attributes
                    return (
            ...
            return (
              'albums' === e.type || 'library-albums' === e.type
                ? (t = r ? se.ALBUM_CLASSICAL : se.ALBUM)
                : ('playlists' !== e.type && 'library-playlists' !== e.type) ||
                  (t = r ? se.PLAYLIST_CLASSICAL : se.PLAYLIST),
              t && (t = ke.prefix ? ke.prefix + ':' + t : t),
              e.relationships.tracks.data.map(function(r) {
                return new vt({
  ...
  var It = createCommonjsModule$1(function(e, t) {
    function strRandomizer() {
      return Math.random()
        .toString(16)
        .substring(2)
  ...
  unwrapExports$1(It)
  It.generateUUID, It.isLibraryType
  var At = It.isNodeEnvironment,
    Ct =
      (It.atob,
      It.btoa,
      It.memoize,
      It.urlEncodeParameters,
      createCommonjsModule$1(function(e, t) {
        Object.defineProperty(t, '__esModule', { value: !0 })
        var r = (function() {
          function DeveloperToken(e) {
            if (
  ...
  unwrapExports$1(Ct)
  var Dt = Ct.DeveloperToken,
    Rt = createCommonjsModule$1(function(e, t) {
      Object.defineProperty(t, '__esModule', { value: !0 })
      var r = (function() {
        function Notifications(e) {
          var t = this
  ...
  unwrapExports$1(Rt)
  var Ot = Rt.Notifications,
    Mt = createCommonjsModule$1(function(e, t) {
      Object.defineProperty(t, '__esModule', { value: !0 })
      var r = (function() {
        function GenericStorage() {
          this._data = {}
  ...
  var Ut = createCommonjsModule$1(function(e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.arrayBufferToString = It.memoize(function(e) {
        for (
          var t = new Uint16Array(e), r = t.length, i = '', n = 0;
          n < r;
          n++
      ...
      (t.base64ToUint8Array = It.memoize(function(e) {
        var r = It.atob(e)
        return t.stringToUint8Array(r)
      })),
      (t.ensureArray = function(e) {
      ...
      (t.stringToUint8Array = It.memoize(function(e) {
        for (
          var t = e.length,
            r = new ArrayBuffer(t),
            i = new Uint8Array(r),
      ...
      (t.stringToUint16Array = It.memoize(function(e) {
        for (
          var t = e.length,
            r = new ArrayBuffer(2 * t),
            i = new Uint16Array(r),
      ...
      (t.uint8ArrayToBase64 = It.memoize(function(e) {
        for (
          var t,
            r,
            i,
  ...
  unwrapExports$1(Ut)
  Ut.arrayBufferToString,
    Ut.base64ToUint8Array,
    Ut.ensureArray,
    Ut.stringToUint8Array,
    Ut.stringToUint16Array,
    Ut.uint8ArrayToBase64
  var xt = createCommonjsModule$1(function(e, t) {
    var r,
      i =
        (Tt && Tt.__awaiter) ||
        function(e, t, r, i) {
              ...
              return n(this, function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return (
                      n.trys.push([1, 3, , 4]),
                      [4, i.apply(null, Ut.ensureArray(e.params))]
                    )
                  case 2:
                    return (o = n.sent()), [2, Object.assign(t, { result: o })]
                  case 3:
                    return (
                      (s = n.sent()),
                      [
  ...
  var Kt,
    Vt = 'https://authorize.music.apple.com',
    qt = /^https?:\/\/(.+\.)*(apple\.com|apps\.mzstatic\.com)(\/[\w\d]+)*$/
  !(function(e) {
        ...
        (ServiceSetupView.prototype.present = function(e, t) {
          ...
          var r = this._calculateClientDimensions(),
            ...
            u = Et(
              {},
              s,
              { left: a / 2 - s.width / 2 + n, top: i / 2 - s.height / 2 + o },
              t
            ),
            c = Object.keys(u)
              .map(function(e) {
          ...
          return (
            /trident|msie/i.test(navigator.userAgent)
              ? ((this._window =
                  window.open(window.location.href, this.target, c) || void 0),
                (this._window.location.href = e))
              : (this._window = window.open(e, this.target, c) || void 0),
            /\bedge\b/i.test(navigator.userAgent) &&
              (this._window.opener = self),
            this.focus(),
            this._window
                ...
                return (
                  'GET' === this.authenticateMethod
                    ? (r =
                        Vt +
                        '/woa?' +
                        buildQueryParams({ a: btoa(this._thirdPartyInfo()) }))
                    ...
                    new Promise(function(n, o) {
                      ...
                      ;(i.dispatch = new zt({
                        methods: {
                          ...
                          thirdPartyInfo: function() {
                            return i._thirdPartyInfo(
                              i.developerToken,
                              Object.assign(i.deeplinkParameters, e)
                            )
                          },
                          unavailable: function() {
                            o(Bt.UNAVAILABLE)
                ...
                return (
                  ...
                  [
                    ...
                    new Promise(function(r, i) {
                      var n =
                        'https://authorize.music.apple.com/upsell?' +
                        buildQueryParams(e)
                      t.present(n),
                        window.addEventListener('message', function(e) {
                          var t = e.data,
                  ...
                  case 0:
                    return [
                      ...
                      (function(e, t) {
                        return (
                          void 0 === t &&
                            (t = 'https://api.music.apple.com/v1'),
                          __awaiter$1(this, void 0, void 0, function() {
                            var r, i
                            return __generator$1(this, function(n) {
                              switch (n.label) {
  ...
  !(function(e) {
    function StoreKit(t, r) {
      var i =
        e.call(this, [
          Wt.authorizationStatusDidChange,
          Wt.authorizationStatusWillChange,
          Wt.eligibleForSubscribeView,
          Wt.storefrontCountryCodeDidChange,
          Wt.userTokenDidChange
        ]) || this
      return (
        (i.developerToken = t),
        (i.apiBase = 'https://api.music.apple.com/v1'),
        (i.persist = 'localstorage'),
        (i.playBase = 'https://play.itunes.apple.com/WebObjects/MZPlay.woa/wa'),
        (i.prefix = 'music'),
        (i.storage = window.localStorage),
        (i._authorizationStatus = Bt.NOT_DETERMINED),
        (i._dispatchedSubscribeView = !1),
        r &&
          (r.deeplink && (i.deeplinkParameters = r.deeplink),
          r.persist && (i.persist = r.persist),
          r.prefix && (i.prefix = r.prefix)),
        (i._developerToken = new Dt(t)),
        (i._serviceSetupView = new Ht(t, {
          authenticateMethod: r && r.authenticateMethod,
          iconURL: r && r.iconURL,
          deeplinkParameters: i.deeplinkParameters
        })),
        ...
        i.userTokenIsValid &&
          ...
          (i._authorizationStatus = i.restrictedEnabled
            ...
            : Bt.AUTHORIZED)),
        (i._storefrontCountryCode = i.storefrontCountryCode),
        At() || i._processLocationHash(window.location.hash),
        i
      )
    }
    __extends$1(StoreKit, e),
      Object.defineProperty(StoreKit.prototype, 'authorizationStatus', {
        get: function() {
          return this._authorizationStatus
        },
        set: function(e) {
          this.dispatchEvent(Wt.authorizationStatusWillChange, {
            authorizationStatus: this._authorizationStatus,
            newAuthorizationStatus: e
          }),
            (this._authorizationStatus = e),
            this.dispatchEvent(Wt.authorizationStatusDidChange, {
              authorizationStatus: e
            })
        },
        enumerable: !0,
      ...
      Object.defineProperty(StoreKit.prototype, 'hasAuthorized', {
        get: function() {
          return this.authorizationStatus > Bt.DENIED
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(StoreKit.prototype, 'restrictedEnabled', {
        ...
        set: function(e) {
          this.userToken &&
            ...
            this._setStorageItem(this.userToken + '.r', e ? '1' : '0'),
            (this._restrictedEnabled = e),
            e && (this.authorizationStatus = Bt.RESTRICTED)
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(StoreKit.prototype, 'storefrontCountryCode', {
        get: function() {
          if (!this._storefrontCountryCode) {
            var e = this._getStorageItem(this.userToken + '.s')
            this._storefrontCountryCode = e || Ft.ID
          }
          return this._storefrontCountryCode
        },
        set: function(e) {
          e && this.userToken
            ...
            : this._removeStorageItem(this.userToken + '.s'),
            (this._storefrontCountryCode = e),
            this.dispatchEvent(Wt.storefrontCountryCodeDidChange, {
              storefrontCountryCode: e
            })
        },
        enumerable: !0,
      ...
      Object.defineProperty(StoreKit.prototype, 'storefrontIdentifier', {
        ...
        set: function(e) {
          ;(this._storefrontIdentifier = e),
            this.dispatchEvent(Wt.storefrontIdentifierDidChange, {
              storefrontIdentifier: e
            })
        },
        enumerable: !0,
        ...
        set: function(e) {
          e && validateToken(e)
            ? ((this.authorizationStatus = this.restrictedEnabled
                ...
                : Bt.AUTHORIZED),
              this._setStorageItem(this.storagePrefix + '.u', e))
            : ((this.authorizationStatus = Bt.NOT_DETERMINED),
              this._removeStorageItem(this.storagePrefix + '.u')),
            (this._userToken = e),
            this.dispatchEvent(Wt.userTokenDidChange, { userToken: e })
        },
        enumerable: !0,
        configurable: !0
      }),
              ...
              case 0:
                return this.authorizationStatus <= Bt.DENIED
                  ...
                  : ((e = new Headers({
                    ...
                    [4, fetch(this.apiBase + '/me/storefront', { headers: e })])
              case 1:
                return (t = n.sent()).ok
                  ? [4, t.json()]
                  : (this._reset(),
          ...
          return __generator$1(this, function(t) {
            switch (t.label) {
              case 0:
                return this.storefrontIdentifier
                  ? [3, 2]
                  : [4, Gt.inferFromLanguages(this.developerToken)]
              case 1:
                ;(e = t.sent()),
                  (this.storefrontIdentifier = e.id),
                  (t.label = 2)
          ...
          return __generator$1(this, function(r) {
            switch (r.label) {
              ...
              case 1:
                return (
                  r.trys.push([1, 3, , 4]),
                  [4, this._serviceSetupView.load({ action: Kt.AUTHORIZE })]
                )
              case 2:
                return (
                  (e = r.sent()),
            ...
            switch (e.label) {
              ...
              case 3:
                return (
                  this.dispatchEvent(Wt.authorizationStatusWillChange, {
                    authorizationStatus: this.authorizationStatus,
                    newAuthorizationStatus: Bt.NOT_DETERMINED
                  }),
                  this._reset(),
                  this.dispatchEvent(Wt.authorizationStatusDidChange, {
                    authorizationStatus: this.authorizationStatus
            ...
            return __generator$1(this, function(r) {
              switch (r.label) {
                case 0:
                  ...
                  if (!e)
                    return (
                      this.dispatchEvent(Wt.eligibleForSubscribeView),
                      (this._dispatchedSubscribeView = !0),
                      [2]
                    )
                  r.label = 1
                case 1:
                  return (
                    r.trys.push([1, 3, , 4]),
                    [4, this._serviceSetupView.load({ action: Kt.SUBSCRIBE })]
                  )
                case 2:
                  return (
                    (t = r.sent()), (this._dispatchedSubscribeView = !0), [2, t]
                  )
                case 3:
                  return r.sent(), [2, this.revokeUserToken()]
                case 4:
            ...
            switch (n.label) {
              case 0:
                return this.authorizationStatus <= Bt.DENIED
                  ...
                  : ((e = new Headers({
                    ...
                    [
                      4,
                      fetch(this.apiBase + '/me/account?meta=subscription', {
                        headers: e
                      })
                    ])
              case 1:
              ...
              case 2:
                return (r = n.sent()).errors
                  ? [2, Promise.reject(r.errors)]
                  : (i = r.meta) && i.subscription
                  ? ((this.storefrontCountryCode = i.subscription.storefront),
                    [2, i.subscription])
                  : [2, Promise.reject('Account error.')]
            }
          })
  ...
  var Yt = (function() {
      function Buffer(e) {
        ...
        ;(this._currentBufferIndex = 0),
          (this.isBufferActionRunning = !1),
          (this.timeToTrim = 10),
          (this.mediaSource = t),
          ke.logger.trace('mediasource', t),
          (this.sourceBuffer = t.addSourceBuffer(Se)),
          ke.logger.trace('sourcebuffer', this.sourceBuffer),
          (this.manifest = r),
          (this._currentTime = i || 0),
          (this.duration = n),
          (this.updateEndHandler = this.dequeueBufferAction.bind(this)),
          (this.bufferActionsQueue = []),
      ...
      return (
        Object.defineProperty(Buffer.prototype, 'currentTime', {
          get: function() {
          ...
          set: function(e) {
            if (this._currentTime !== e) {
              ...
              t &&
                i &&
                (this.removeToTime(r),
                this.addSegment(this.currentBufferIndex + 1),
                (this.timeToTrim += 10))
            }
          },
          enumerable: !0,
        ...
        Object.defineProperty(Buffer.prototype, 'currentBufferIndex', {
          ...
          set: function(e) {
            var t = this.segments,
              r = this.mediaSource
            e === t.length - 1
              ? this.addBufferAction(r.endOfStream.bind(r))
              : this.addSegment(e + 1),
              (this._currentBufferIndex = e)
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(Buffer.prototype, 'startBufferedTime', {
          get: function() {
            return 0 === this.sourceBuffer.buffered.length
              ? 0
                  ...
                  return (
                    ...
                    r <= e && i >= e
                      ...
                      : (this.removeToTime(i),
                        ...
                        (a = e / n < 0.05 ? e / n : e / n - 0.05),
                        (s = Math.floor(o.length * a)),
                        this.addSegment(s),
                        [4, this.waitForSeekToLoad(e)])
                  )
                case 1:
                  return u.sent(), [2]
              }
            ...
            return __generator(this, function(i) {
              switch (i.label) {
                case 0:
                  return (
                    (e = this).sourceBuffer,
                    (t = e.bufferActionsQueue),
                    this.isBufferUpdating
                      ? [2]
                      : (r = t.shift())
                      ? ((this.isBufferActionRunning = !0), [4, r()])
                      : [3, 2]
                  )
                case 1:
                  i.sent(),
                    (this.isBufferActionRunning = !1),
                    this.isBufferUpdating || this.dequeueBufferAction(),
                    (i.label = 2)
                case 2:
                  return [2]
              }
        ...
        (Buffer.prototype.addBufferAction = function(e) {
          this.bufferActionsQueue.push(e),
            this.isBufferUpdating || this.dequeueBufferAction()
        }),
        (Buffer.prototype.addSegment = function(e) {
          ...
          this.addBufferAction(function() {
            return new Promise(function(r) {
              ...
              o &&
                o.load().then(function(i) {
                  try {
                    t.sourceBuffer.appendBuffer(i),
                      (t.currentBufferIndex = e),
                      (t.isOverBufferLimit = !1)
                  } catch (e) {
                    'QuotaExceededError' === e.name &&
                      (t.isOverBufferLimit = !0)
                  }
                  r()
                })
            })
          ...
          return (
            ...
            __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(a) {
                switch (a.label) {
                  case 0:
                    return (i = !!window.sessionStorage && t) &&
                      (r = window.sessionStorage.getItem(e))
                      ? [2, Promise.resolve(new this(r, e))]
                      : ((n = new Date().getTime()), [4, fetch(e)])
                  case 1:
                    return [4, a.sent().text()]
                  case 2:
                    return (
                      (r = a.sent()),
                      ((o = new this(r, e)).downlink = (function(e, t) {
                        return (
                          (8 * t.length) /
                      ...
                      i && window.sessionStorage.setItem(e, r),
                      [2, Promise.resolve(o)]
                    )
                }
              })
            ...
            if (!this._byteRanges) {
              var e = (function(e) {
                ...
                n = t.map(function(e) {
                  var t = e[0],
                    r = e[1]
                  return new ir({ url: i, startByte: r, length: t })
                }),
                o = e.byterange.split('@'),
                a = o[0],
                s = o[1]
              n.unshift(new ir({ url: i, startByte: s, length: a })),
                (this._byteRanges = n)
            }
  ...
  var nr,
    ...
    ar,
    sr = 'mk-player-tsid',
    ur = Ve.bufferedProgressDidChange,
    cr = Ve.mediaCanPlay,
    lr = Ve.mediaItemDidChange,
    dr = Ve.mediaItemStateDidChange,
    pr = Ve.mediaItemStateWillChange,
    hr = Ve.mediaItemWillChange,
    fr = Ve.mediaPlaybackError,
    yr = Ve.mediaPlaybackPreview,
    br = Ve.metadataDidChange,
    mr = Ve.primaryPlayerDidChange,
    _r = Ve.playbackBitrateDidChange,
    gr = Ve.playbackDurationDidChange,
    vr = Ve.playbackProgressDidChange,
    Pr = Ve.playbackStateDidChange,
    wr = Ve.playbackStateWillChange,
    Sr = Ve.playbackTargetAvailableDidChange,
    kr = Ve.playbackTimeDidChange,
    Er = Ve.playbackVolumeDidChange,
    Tr = tr.playing,
    Ir = (function(e) {
      function BasePlayer(t, r) {
        ...
        ;(i.privateEnabled = !1),
          (i.siriInitiated = !1),
          (i._bitrate = Xt.STANDARD),
          (i._currentBufferedProgress = 0),
          (i._paused = !1),
          (i._playbackState = tr.none),
          (i._stopped = !1),
          (i._timingAccuracy = er.ROUND),
          (i._currentPlaybackProgress = 0),
          (i._downlinkSamples = []),
          (i._isPrimaryPlayer = !0),
          (i._mode = Jt.DEFAULT),
          (i._nowPlayingItem = null),
          (i._playActivityStub = new ve()),
          (i._playbackTargetAvailable = !1),
          (i._serial = Date.now().toString()),
          (i._bitrate = t.bitrate || Xt.STANDARD),
          (i._timingAccuracy = t.accurateTiming ? er.ACCURATE : er.ROUND),
          window.navigator &&
            window.navigator.connection &&
            window.navigator.connection.downlink &&
            i._recalculateBitrate(
              100 * (window.navigator.connection.downlink || 0)
            ),
          (i.storekit = t.storekit),
          (i.privateEnabled = t.privateEnabled || !1),
          (i.siriInitiated = t.siriInitiated || !1)
        var n = 'visibilitychange',
          o = 'visibilityState'
        void 0 !== document.mozHidden
          ? ((n = 'mozvisibilitychange'), (o = 'mozVisibilityState'))
          : void 0 !== document.msHidden
          ? ((n = 'msvisibilitychange'), (o = 'msVisibilityState'))
          : void 0 !== document.webkitHidden &&
            ((n = 'webkitvisibilitychange'), (o = 'webkitVisibilityState')),
          document.addEventListener(n, function(e) {
            return (
              ke.logger.log('visibilityState', e.target[o]),
              'hidden' === e.target[o]
                ? i.isPlaying && i.playActivity.exit(i.currentPlaybackTime)
                : 'visible' === e.target[o]
        ...
        return (
          ...
          window.addEventListener(
            ...
            function(e) {
              var t = e.key,
                r = e.newValue
              t === sr && r && (i.isPrimaryPlayer = r === i._serial)
            },
            !1
          ),
          localStorage.setItem(sr, i._serial),
          setTimeout(function() {
            i.playActivity.activate(!i.isPlaying)
          }, 500),
          i
      ...
      return (
        __extends(BasePlayer, e),
        Object.defineProperty(BasePlayer.prototype, 'bitrate', {
          get: function() {
            return this._bitrate
          },
          set: function(e) {
            this._bitrate !== e &&
              ((this._bitrate = e), this.dispatchEvent(_r, { bitrate: e }))
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(BasePlayer.prototype, 'currentBufferedProgress', {
          ...
          set: function(e) {
            this._currentBufferedProgress !== e &&
              ((this._currentBufferedProgress = e),
              this.dispatchEvent(ur, { progress: e }))
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(BasePlayer.prototype, 'currentPlaybackDuration', {
          get: function() {
            return !this.previewOnly &&
              ...
              this.nowPlayingItem &&
              this.nowPlayingItem.playbackDuration
              ? this._timing(this.nowPlayingItem.playbackDuration / 1e3)
              : this._timing(this._currentDuration)
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(BasePlayer.prototype, 'currentPlaybackProgress', {
          ...
          set: function(e) {
            this._currentPlaybackProgress !== e &&
              ((this._currentPlaybackProgress = e),
              this.dispatchEvent(vr, { progress: e }))
          },
          enumerable: !0,
          configurable: !0
        }),
          ...
          set: function(e) {
            e !== this._isPrimaryPlayer &&
              ...
              this._isPrimaryPlayer
                ? localStorage.setItem(sr, this._serial)
                : (this.dispatchEvent(mr, { target: this }), this.pause()))
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(BasePlayer.prototype, 'nowPlayingItem', {
          ...
          set: function(e) {
            e
              ? (this._nowPlayingItem && this._nowPlayingItem.isEqual(e)) ||
                (this.dispatchEvent(hr, { item: e }),
                this.isPlaying && this.pause(),
                this.canSupportDRM && this.extension.cancelPendingRenewal(),
                this._nowPlayingItem &&
                  ((this._nowPlayingItem.state = pt.ended),
                  this._nowPlayingItem.endMonitoringStateDidChange(),
                  this._nowPlayingItem.endMonitoringStateWillChange()),
                (this._nowPlayingItem = e),
                (this._nowPlayingItem.state = pt.playing),
                e && e.info && this._setTargetElementTitle(e.info),
                this.dispatchEvent(lr, { item: e }),
              ...
              switch (e.label) {
                ...
                case 1:
                  return (
                    e.sent(),
                    (this._paused = !0),
                    [4, this.playActivity.pause(this.currentPlaybackTime)]
                  )
                case 2:
                  e.sent(), (e.label = 3)
                case 3:
          ...
          return (
            ...
            __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(s) {
                switch (s.label) {
                  case 0:
                    return e && e.isPlayable
                      ? (e.beginMonitoringStateDidChange(function(e) {
                          return a.dispatchEvent(dr, e)
                        }),
                        e.beginMonitoringStateWillChange(function(e) {
                          return a.dispatchEvent(pr, e)
                        }),
                        (r = this._paused && !t),
                        (i = !this.canSupportDRM),
                        this.previewOnly ||
                        ((!this.hasAuthorization || i) && !e.playRawAssetURL)
                          ? ((this.nowPlayingItem = e),
                            i && this.dispatchEvent(yr, { item: e }),
                            [2, this._playAssetURL(e.previewURL, r)])
                          : e.playRawAssetURL && e.attributes.assetUrl
                          ? ((this.nowPlayingItem = e),
                            [2, this._playAssetURL(e.attributes.assetUrl, r)])
                          : [4, this._loadMedia()])
                      : [
                          2,
                          Promise.reject(
                            new re(re.MEDIA_PLAYBACK, 'Not Playable.')
                          )
                        ]
                  case 1:
                  ...
                  case 2:
                    return (
                      ...
                      e.playRawAssetURL
                        ? ((this.nowPlayingItem = e),
                          [2, this._playAssetURL(e.assetURL, r)])
                        : ((this.extension.initiated = t),
                          this.extension.setMediaItem(e),
                          (this.nowPlayingItem = e),
                          (e.state = pt.loading),
                          [4, rr.load(e.assetURL, !1)])
                    )
                  case 3:
                    return (
                      (n = s.sent()),
                      (this.extension.extURI = n.extURI),
                      (e.state = pt.ready),
                      this.extension.isFairplay
                        ? [2, this._playAssetURL(e.assetURL, r)]
                        : [3, 4]
                    )
                  case 4:
                    return (
                      n.downlink && this._recalculateBitrate(n.downlink),
                      this._buffer && this._buffer.remove(),
                      (o = new MediaSource()),
                      [
                        4,
                        this._playAssetURL(
                          window.window.URL.createObjectURL(o),
                          !0
                        )
                      ]
                    )
                  case 5:
                    s.sent(),
                      o.addEventListener('sourceopen', function(t) {
                        if (
                          0 === o.activeSourceBuffers.length &&
                          ((a._buffer = new Yt({
                            duration: e.playbackDuration / 1e3,
                            mediaSource: o,
                            manifest: n
                          })),
                          !r && a.playbackState !== tr.paused)
                        )
                          return a._playMedia()
                      }),
                      (s.label = 6)
        ...
        Object.defineProperty(BasePlayer.prototype, 'playbackTargetAvailable', {
          ...
          set: function(e) {
            e !== this._playbackTargetAvailable &&
              ((this._playbackTargetAvailable = e),
              this.dispatchEvent(Sr, { available: e }))
          },
          enumerable: !0,
          configurable: !0
        }),
              ...
              return __generator(this, function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      ...
                      [
                        4,
                        e.prepareToPlay(
                          this.storekit.developerToken,
                          this.storekit.userToken,
                  ...
                  case 3:
                    return (
                      (r = i.sent()),
                      [re.AUTHORIZATION_ERROR, re.SUBSCRIPTION_ERROR].includes(
                        r.errorCode
                      )
                        ? [4, this.storekit.revokeUserToken()]
                        : [3, 5]
                    )
                  case 4:
                    return i.sent(), [3, 12]
                  ...
                  case 6:
                    return (
                      i.trys.push([6, 9, , 10]),
                      [4, this.storekit.renewUserToken()]
                    )
                  case 7:
                    return (
                      i.sent(),
                  ...
                  case 8:
                    return (
                      i.sent(),
                      (e.playbackData = this._playbackDataForItem(e)),
                      [2, e]
                    )
                  case 9:
                    return i.sent(), [3, 10]
                  case 10:
                    return [3, 12]
                  case 11:
                    r.errorCode === re.CONTENT_UNAVAILABLE &&
                      e.equivalent &&
                      (r = new re(re.CONTENT_EQUIVALENT, r.message)),
                      (i.label = 12)
                  case 12:
                    return t
                      ? [2, Promise.reject(r)]
                      : (this.dispatchEvent(fr, r), [2])
                  case 13:
                    return (
                      (e.playbackData = this._playbackDataForItem(e)), [2, e]
                    )
                }
              })
            })
        ...
        Object.defineProperty(BasePlayer.prototype, 'previewOnly', {
          get: function() {
            return this._mode === Jt.PREVIEW_ONLY
          },
          set: function(e) {
            this._mode = e ? Jt.PREVIEW_ONLY : Jt.DEFAULT
          },
          enumerable: !0,
          configurable: !0
        }),
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              switch (r.label) {
                case 0:
                  return (
                    (t = this.currentPlaybackTime),
                    this._buffer ? [4, this._buffer.seek(e)] : [3, 2]
                  )
                case 1:
                  r.sent(), (r.label = 2)
                case 2:
                ...
                case 4:
                  return r.sent(), [4, this.playActivity.scrub(e, ce.SCRUB_END)]
                case 5:
                  return r.sent(), [2]
              }
            })
        ...
        Object.defineProperty(BasePlayer.prototype, 'storekit', {
          ...
          set: function(e) {
            var t = this
            e &&
              (e.addEventListener(Wt.authorizationStatusWillChange, function(
                e
              ) {
                    ...
                    switch (e.label) {
                      case 0:
                        return this.isPlaying
                          ? r > Bt.DENIED && i < Bt.RESTRICTED
                            ? [4, this.stop(ce.PLAYBACK_SUSPENDED)]
                            : [3, 2]
                          : [3, 4]
                      case 1:
                        return e.sent(), [3, 4]
            ...
            return __generator(this, function(t) {
              switch (t.label) {
                ...
                case 1:
                  return (
                    t.sent(),
                    [4, this.playActivity.stop(this.currentPlaybackTime, e)]
                  )
                case 2:
        ...
        (BasePlayer.prototype._calculatePlaybackProgress = function() {
          this.currentPlaybackProgress =
            Math.round(
              100 *
                (this.currentPlaybackTime / this.currentPlaybackDuration || 0)
            ) / 100
        }),
        Object.defineProperty(BasePlayer.prototype, 'playActivity', {
          get: function() {
            return this._storekit &&
              this._storekit.userTokenIsValid &&
              this._requiresPlayActivity()
              ? (this._playActivityClient ||
                  (this._playActivityClient = new ge(
                    this._storekit.developerToken,
                    this._storekit.userToken,
                    this._storekit.storefrontCountryCode,
                    {
                      app: {
                        build: ke.app.build,
                        name: ke.app.name,
                        version: ke.app.version
                      },
                      logInfo: ke.logger.enabled,
                      sourceType: ke.sourceType
                    }
                  )),
                this._playActivityClient)
              : this._playActivityStub
          },
          enumerable: !0,
          configurable: !0
        }),
        (BasePlayer.prototype._playbackDataForItem = function(e) {
          var t = this
          return e.isCloudUpload
            ? e.assets[0]
            : e.assets.filter(function(e) {
                var r = e.flavor,
                  i = new RegExp(
                    '\\d{1,2}\\:(c' +
                      (t.extension.isFairplay ? 'bc' : 'tr') +
                      'p)(\\d{2,3})',
                    'i'
                  )
        ...
        (BasePlayer.prototype._recalculateBitrate = function(e) {
          this._downlinkSamples.push(e),
            this.medianDownlink && this.medianDownlink >= 65
              ? (this.bitrate = Xt.HIGH)
              : (this.bitrate = Xt.STANDARD)
        }),
        (BasePlayer.prototype._requiresPlayActivity = function() {
          return (
            !!this.nowPlayingItem &&
            mediaRequiresPlayActivity(this.nowPlayingItem)
          )
        }),
        (BasePlayer.prototype._timing = function(e) {
          return (
            void 0 === e && (e = 0),
            this._timingAccuracy === er.ROUND ? Math.round(e) : e
          )
        }),
        BasePlayer
      )
    ...
    Ar = (function() {
      function PlayerStub() {
        ;(this.bitrate = Xt.STANDARD),
          (this.canSupportDRM = !1),
          (this.currentBufferedProgress = NaN),
          (this.currentPlaybackDuration = NaN),
          (this.currentPlaybackProgress = NaN),
          (this.currentPlaybackTime = NaN),
          (this.currentPlaybackTimeRemaining = NaN),
          ...
          (this.playbackState = tr.none),
          (this.playbackTargetAvailable = !1),
          (this.volume = NaN),
          (this._playActivity = new ve())
      }
      return (
        Object.defineProperty(PlayerStub.prototype, 'playActivity', {
          get: function() {
        ...
        (PlayerStub.prototype.activate = function() {}),
        (PlayerStub.prototype.deactivate = function() {}),
        (PlayerStub.prototype.destroy = function() {}),
        (PlayerStub.prototype.mute = function() {}),
        (PlayerStub.prototype.pause = function() {
          return Promise.resolve()
        }),
        ...
        (PlayerStub.prototype.showPlaybackTargetPicker = function() {}),
        (PlayerStub.prototype.stop = function(e) {
          return Promise.resolve()
        }),
        PlayerStub
      )
  ...
  var Cr,
    ...
    Mr = (function(e) {
      function KeySession() {
        var t =
          e.call(this, [ar.playbackLicenseError, ar.playbackSessionError]) ||
          this
        return (
          (t.initiated = !0),
          (t.isLibrary = !1),
          (t.keySystem = or.FAIRPLAY),
          (t._storage = window.sessionStorage),
          (t.boundDispatchKeyError = t.dispatchKeyError.bind(t)),
          (t.boundDispatchSessionError = t.dispatchSessionError.bind(t)),
          (t.boundHandleSessionCreation = t.handleSessionCreation.bind(t)),
          t
        )
      }
      return (
        __extends(KeySession, e),
        Object.defineProperty(KeySession.prototype, 'extID', {
          get: function() {
        ...
        Object.defineProperty(KeySession.prototype, 'isFairplay', {
          get: function() {
            return this.keySystem === or.FAIRPLAY
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(KeySession.prototype, 'isPlayready', {
          get: function() {
            return this.keySystem === or.PLAYREADY
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(KeySession.prototype, 'isWidevine', {
          get: function() {
            return this.keySystem === or.WIDEVINE
          },
          enumerable: !0,
          configurable: !0
        }),
                  ...
                  case 1:
                    return (n = o.sent()).ok
                      ...
                      : [
                          2,
                          Promise.reject(
                            new re(re.MEDIA_LICENSE, 'Error acquiring license')
                          )
                        ]
                  case 2:
                    return [2, o.sent()]
        ...
        (KeySession.prototype.cancelPendingRenewal = function() {
          this._pendingRenewal &&
            (clearTimeout(this._pendingRenewal),
            (this._pendingRenewal = void 0))
        }),
        ...
        (KeySession.prototype.dispatchKeyError = function(e) {
          this.dispatchEvent(ar.playbackSessionError, new re(re.MEDIA_KEY, e))
        }),
        (KeySession.prototype.dispatchSessionError = function(e) {
          this.dispatchEvent(
            ar.playbackSessionError,
            new re(re.MEDIA_SESSION, e)
          )
        }),
                ...
                case 0:
                  if (!this.keyCertURL)
                    return [
                      2,
                      Promise.reject(
                        new re(re.MEDIA_SESSION, 'No certificate URL')
                      )
                    ]
                  if (
                    (((e = document.createElement('a')).href = this.keyCertURL),
                    (t = Date.now()),
                    (r = ('' + e.hostname + e.pathname).replace(
                      /[^a-z0-9.]/gi,
                      '.'
                    )),
                    (i = this._storage.getItem(r)),
                    (n = parseInt(
                      this._storage.getItem('com.ai.mk.vmcc.exp') || '',
                      10
                    )),
                    i && n && n > t)
                  ) {
                    for (o = new Uint8Array(i.length), a = i.length; a--; )
                      o[a] = i.charCodeAt(a)
                    return [2, o.buffer]
                  }
                  ...
                  return (
                    ...
                    /^\<\?xml/.test(p)
                      ? [
                          2,
                          Promise.reject(
                            new re(re.MEDIA_CERTIFICATE, 'Invalid certificate.')
                          )
                        ]
                      : (this._storage.setItem(r, p),
        ...
        (KeySession.prototype.handleSessionCreation = function(e) {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              return [
                2,
                this.createSession(e).catch(function(e) {
        ...
        (KeySession.prototype._handleLicenseResponse = function(e, t, r) {
          ...
          if (e.license) {
            e['renew-after'] &&
              (this._pendingRenewal = setTimeout(function() {
          ...
          this.dispatchEvent(ar.playbackLicenseError, o)
        }),
        KeySession
      )
    })(dt),
    Lr = (function(e) {
      ...
      return (
        __extends(EncryptedSession, e),
        (EncryptedSession.prototype.attachMedia = function(e, t) {
          var r = this
          return (
        ...
        (EncryptedSession.prototype.createSession = function(e) {
          var t = this,
            ...
            i = e.initDataType,
            n = e.target
          return this._mediaKeysServerCertificate
            ? this._createSession(n, r, i)
            : this.loadCertificateBuffer().then(function(e) {
                return n.mediaKeys.setServerCertificate(e).then(function() {
                  return (
                    (t._mediaKeysServerCertificate = e),
                    t._createSession(n, r, i)
                  )
                })
              })
        }),
        ...
        (EncryptedSession.prototype._createSession = function(e, t, r) {
          ...
          return (
            i.addEventListener('message', this.startLicenseSession.bind(this)),
            i.generateRequest(r, n)
          )
        }),
        EncryptedSession
      )
    ...
    Nr = (function(e) {
      ...
      return (
        __extends(MSSession, e),
        (MSSession.prototype.attachMedia = function(e, t) {
          return (
            (this.keySystem = t.keySystem),
            e.addEventListener(
              'msneedkey',
        ...
        (MSSession.prototype.createSession = function(e) {
          ...
          var n = r.msKeys.createSession(nr.MP4, t)
          return (
            n.addEventListener('mskeyerror', this.dispatchKeyError),
            n.addEventListener(
              'mskeymessage',
              this.startLicenseSession.bind(this)
            ),
            n
          )
        }),
    ...
    jr = (function(e) {
      ...
      return (
        __extends(WebKitSession, e),
        (WebKitSession.prototype.attachMedia = function(e, t) {
          return (
            e.addEventListener(
              'webkitneedkey',
              this.boundHandleSessionCreation,
        ...
        (WebKitSession.prototype.createSession = function(e) {
          ...
          return this.loadCertificateBuffer().then(function(e) {
            var n = t._concatInitDataIdAndCertificate(r, o, e),
              a = i.webkitKeys.createSession(nr.MP4, n)
            ;(a.contentId = o),
              a.addEventListener('webkitkeyerror', t.dispatchKeyError),
              a.addEventListener(
                'webkitkeymessage',
                t.startLicenseSession.bind(t)
              )
          })
        }),
        (WebKitSession.prototype._concatInitDataIdAndCertificate = function(
          e,
          t,
          r
        ) {
          ...
          var i = 0,
            n = new ArrayBuffer(
              e.byteLength + 4 + t.byteLength + 4 + r.byteLength
            ),
            o = new DataView(n)
          new Uint8Array(n, i, e.byteLength).set(e),
            (i += e.byteLength),
          ...
          return (
            a.set(t),
            (i += a.byteLength),
            o.setUint32(i, r.byteLength, !0),
            (i += 4),
            new Uint8Array(n, i, r.byteLength).set(r),
    ...
    Ur = (function(e) {
      function MediaExtension(t, r) {
        ...
        if (
          ((i.audio = t),
          ke.browser().isIE ||
            (ke.browser().isSafari && ke.browser().engineMajorVersion <= 601))
        )
          return i
        if (
          window.WebKitMediaKeys &&
          window.WebKitMediaKeys.isTypeSupported(or.FAIRPLAY + '.1_0', nr.MP4)
        )
          (i.session = new jr()),
            i.session.attachMedia(t, { keySystem: or.FAIRPLAY })
        else if (
          window.MSMediaKeys &&
          window.MSMediaKeys.isTypeSupported(or.PLAYREADY, nr.MP4)
        )
          (i.session = new Nr()),
            i.session.attachMedia(t, { keySystem: or.PLAYREADY })
        else if (i.hasMediaKeySupport && t.canPlayType(r)) {
          i.session = new Lr()
          var n = [
            {
              initDataTypes: ['cenc', 'keyids'],
              audioCapabilities: [{ contentType: r }],
              distinctiveIdentifier: 'optional',
              persistentState: 'required'
            }
          ]
          navigator
            .requestMediaKeySystemAccess(or.WIDEVINE, n)
            .then(function(e) {
              i.session.attachMedia(t, e)
            })
            .catch(function() {
              navigator
                .requestMediaKeySystemAccess(or.PLAYREADY, n)
                .then(function(e) {
                  i.session.attachMedia(t, e)
                })
            })
        ...
        return (
          i.session &&
            i.session.addEventListener(ar.playbackLicenseError, function(e) {
              i.dispatchEvent(ar.playbackLicenseError, e)
            }),
          i
        )
      }
      return (
        __extends(MediaExtension, e),
        Object.defineProperty(MediaExtension.prototype, 'hasMediaKeySupport', {
          get: function() {
            return !!(
              navigator &&
        ...
        (MediaExtension.prototype.setMediaItem = function(e) {
          ;(this.session.developerToken = ke.storekit.developerToken),
            (this.session.userToken = ke.storekit.userToken),
            (this.session.adamId = e.songId),
            (this.session.isLibrary = e.isCloudItem),
            this.session.setKeyURLs(e.keyURLs)
        }),
    ...
    xr = Ve.mediaCanPlay,
    Br = Ve.mediaPlaybackError,
    zr = Ve.metadataDidChange,
    Kr = Ve.playbackDurationDidChange,
    Vr = Ve.playbackTimeDidChange,
    qr = Ve.playbackVolumeDidChange,
    Fr = (tr.completed, tr.ended),
    Hr = tr.loading,
    Wr = tr.paused,
    Gr = tr.playing,
    Yr = tr.seeking,
    ...
    Xr = (function(e) {
      function AudioPlayer(t) {
        ...
        // console.log(i)
        // var audioSrc = audioContext.createMediaElementSource(i)

        return (
          (i.autoplay = !1),
          (i.id = 'apple-music-player'),
          (i.controls = !1),
          (i.muted = !1),
          (i.playbackRate = 1),
          (i.preload = 'metadata'),
          ...
          (r.extension = new Ur(i, Se)),
          r.extension.addEventListener(ar.playbackLicenseError, function(e) {
            console.log('thefuckevenmore')
            r.dispatchEvent(Br, e)
          }),
          r.extension.addEventListener(ar.playbackSessionError, function(e) {
            console.log('thefuck')
            r.dispatchEvent(Br, new re(re.MEDIA_SESSION, e))
          }),
      ...
      return (
        ...
        (AudioPlayer.prototype.destroy = function() {
          var e = this
          return (
            this.extension.destroy(this.audio),
            Zr.forEach(function(t) {
              return e.audio.removeEventListener(t, e)
            }),
            null !== this.audio.parentNode &&
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              switch (e.type) {
                ...
                case 'error':
                case 'loadedmetadata':
                  this.dispatchEvent(zr, e)
                  break
                case 'loadstart':
                  this.playbackState = Hr
                  break
                case 'pause':
                  this.playbackState = this._stopped ? Qr : Wr
                  break
                case 'playing':
                  ;(this._paused = !1),
                    (this._stopped = !1),
                  ...
                  break
                case 'progress':
                  1 === (t = this.audio.buffered).length &&
                    0 === t.start(0) &&
                    (this.currentBufferedProgress = Math.round(
                      (t.end(0) / this.currentPlaybackDuration) * 100
                    ))
                  break
                case 'seeked':
                  this._paused
                    ? (this.playbackState = Wr)
                    : this._stopped
                ...
                case 'seeking':
                  this.playbackState === Wr
                    ? (this._paused = !0)
                    : this.playbackState === Qr && (this._stopped = !0),
                ...
                case 'timeupdate':
                  this.dispatchEvent(Vr, {
                    ...
                    currentPlaybackTimeRemaining: this
                      .currentPlaybackTimeRemaining
                  }),
                    this._calculatePlaybackProgress(),
                    this._buffer &&
                      (this._buffer.currentTime = this.currentPlaybackTime)
                  break
                case 'volumechange':
                  this.dispatchEvent(qr, e)
                  break
                case 'waiting':
                  this.playbackState = $r
              }
              return [2]
            })
          })
        ...
        (AudioPlayer.prototype._playAssetURL = function(e, t) {
          return (
            void 0 === t && (t = !1),
            (this.audio.src = e),
            t ? this._loadMedia() : this._playMedia()
          )
        }),
    ...
    Jr = (function(e) {
      function Preloader(t, r) {
        return void 0 === r && (r = 0.3), e.call(this, t, r) || this
      }
      return (
        __extends(Preloader, e),
        (Preloader.prototype.handlePlaybackThreshold = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(e) {
              switch (e.label) {
                case 0:
                  return [
                    4,
                    this._playbackController.prepareToPlay(this._next, !1, !0)
                  ]
                case 1:
                  return e.sent(), [2]
              }
        ...
        (Preloader.prototype.shouldMonitor = function() {
          return (
            !!this._playbackController.hasAuthorization &&
            ((this._next = this._playbackController.queue.nextPlayableItem),
      ...
      (function() {
        function PlaybackMonitor(e, t) {
          ...
          ;(this.isMonitoring = !1),
            ...
            (this._percentage = t),
            this.reset(),
            (this._boundHandleTimeChange = this.handleTimeChange.bind(this)),
            (this._boundUpdateThreshhold = this.updateThreshold.bind(this)),
            this._playbackController.addEventListener(
              Ve.mediaItemDidChange,
              function() {
        ...
        return (
          (PlaybackMonitor.prototype.clearMonitor = function() {
          ...
          (PlaybackMonitor.prototype.clearListeners = function() {
            this._playbackController.removeEventListener(
              Ve.playbackDurationDidChange,
              this._boundUpdateThreshhold
            ),
              this._playbackController.removeEventListener(
                Ve.playbackTimeDidChange,
                this._boundHandleTimeChange
              )
          }),
          (PlaybackMonitor.prototype.handleMediaItemChange = function() {
            this.isMonitoring && this.clearMonitor(),
              this.shouldMonitor() &&
                (this._playbackController.addEventListener(
                  Ve.playbackDurationDidChange,
                  this._boundUpdateThreshhold
              ...
              return __generator(this, function(e) {
                switch (e.label) {
                  case 0:
                    return (
                      this._threshhold < 0 &&
                        this.updateThreshold({ duration: t }),
                      r < this._threshhold
                        ? [2]
                        : (this.clearListeners(),
                          [4, this.handlePlaybackThreshold()])
                    )
                  case 1:
  ...
  !(function(e) {
    ...
    ((Rr = e.PlayerSeek || (e.PlayerSeek = {}))[(Rr.FORWARD = 30)] = 'FORWARD'),
    (Rr[(Rr.BACK = 15)] = 'BACK')
  var ei = Ve.bufferedProgressDidChange,
    ti = Ve.mediaCanPlay,
    ri = Ve.mediaItemDidChange,
    ii = Ve.mediaItemStateDidChange,
    ni = Ve.mediaItemStateWillChange,
    oi = Ve.mediaItemWillChange,
    ai = Ve.mediaPlaybackError,
    si = Ve.mediaPlaybackPreview,
    ui = Ve.metadataDidChange,
    ci = Ve.primaryPlayerDidChange,
    li = Ve.playbackBitrateDidChange,
    di = Ve.playbackDurationDidChange,
    pi = Ve.playbackProgressDidChange,
    hi = Ve.playbackStateDidChange,
    fi = Ve.playbackStateWillChange,
    yi = Ve.playbackTargetAvailableDidChange,
    bi = Ve.playbackTimeDidChange,
    mi = Ve.playbackVolumeDidChange,
    _i = Ve.queueItemsDidChange,
    gi = Ve.queuePositionDidChange,
    vi = [
      ei,
      ti,
      ri,
    ...
    Pi = (function(t) {
      function SerialPlayback(r) {
        var i = t.call(this, [_i, gi].concat(vi)) || this
        return (
          (i._playerState = {
          ...
          (i._queue = new St({})),
          (i._repeatMode = Cr.none),
          (i._shuffleMode = Dr.off),
          (i._storekit = r.storekit),
          (i._playerOptions = r),
          (i._playersByType = {}),
          (i._currentPlayer = i._getPlayerByType('audio') || new Ar()),
          (i._preloader = new Jr(i)),
          i
        )
      }
      return (
        __extends(SerialPlayback, t),
        Object.defineProperty(SerialPlayback.prototype, 'bitrate', {
          get: function() {
        ...
        Object.defineProperty(SerialPlayback.prototype, 'queue', {
          ...
          set: function(e) {
            ...
            this.hasAuthorization &&
              ...
              this.shuffleMode === Dr.songs && e.shuffle(!1),
              (this._currentPlayer.nowPlayingItem = null)
            ...
            r &&
              ...
              e.addEventListener(gi, function(e) {
                return t.dispatchEvent(gi, e)
              }),
              (this._queue = e),
              this.dispatchEvent(_i, e.items)
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(SerialPlayback.prototype, 'repeatMode', {
          ...
          set: function(e) {
            ;(this._repeatMode = e),
              this._updatePlayerState('isLooping', this._repeatMode === Cr.one)
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(SerialPlayback.prototype, 'shuffle', {
          set: function(e) {
            this.shuffleMode = e ? Dr.songs : Dr.off
          },
          enumerable: !0,
          configurable: !0
        }),
        Object.defineProperty(SerialPlayback.prototype, 'shuffleMode', {
          ...
          set: function(e) {
            e !== this._shuffleMode &&
              ((this._shuffleMode = e),
              e === Dr.songs ? this.queue.shuffle() : this.queue.unshuffle(),
              this.nowPlayingItem &&
                (this.queue.position = this.queue.indexForItem(
                  this.nowPlayingItem.id
                )))
          },
          enumerable: !0,
          configurable: !0
        ...
        Object.defineProperty(SerialPlayback.prototype, 'storekit', {
          ...
          set: function(e) {
            var t = this
            e &&
              (e.addEventListener(ze.authorizationStatusWillChange, function(
                e
              ) {
                var r = e.authorizationStatus,
                  i = e.newAuthorizationStatus
        ...
        (SerialPlayback.prototype.changeToMediaItem = function(e) {
          return __awaiter(this, void 0, void 0, function() {
            var t
            return __generator(this, function(r) {
              return -1 === (t = this.queue.indexForItem(e))
                ? [2, Promise.reject(new re(re.MEDIA_DESCRIPTOR))]
                : [2, this.changeToMediaAtIndex(t)]
            })
          })
        }),
        ...
        (SerialPlayback.prototype.play = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(e) {
              return this._currentPlayer.nowPlayingItem
                ? [2, this._currentPlayer.play()]
                : !this._queue || this._queue.isEmpty
                ? [2]
                : -1 !== this.queue.nextPlayableItemIndex
                ? [
                    2,
                    this.changeToMediaAtIndex(this.queue.nextPlayableItemIndex)
                  ]
                : [2]
            })
          })
                ...
                try {
                  ...
                  if (
                    ((i =
                      !r &&
                      -1 ===
                        [re.DEVICE_LIMIT, re.STREAM_UPSELL].indexOf(
                          e.errorCode
                        )),
                    this.continuous && i)
                  )
        ...
        (SerialPlayback.prototype.showPlaybackTargetPicker = function() {
          this._currentPlayer.playbackTargetAvailable &&
        ...
        (SerialPlayback.prototype.seekForward = function() {
          return __awaiter(this, void 0, void 0, function() {
            var t
            return __generator(this, function(r) {
              return (t = this.currentPlaybackTime + e.PlayerSeek.FORWARD) >
                this.currentPlaybackDuration
                ? [2, this.skipToNextItem()]
                : [2, this.seekToTime(t)]
            })
          })
        }),
        (SerialPlayback.prototype.seekBackward = function() {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              return (
                (t = this.currentPlaybackTime - e.PlayerSeek.BACK),
                [2, this.seekToTime(Math.max(0, t))]
              )
            })
          })
        }),
        ...
        (SerialPlayback.prototype._applyPlayerState = function(e) {
          var t = this
          return (
            Object.keys(this._playerState).forEach(function(r) {
                ...
                switch (p.label) {
                  case 0:
                    ...
                    ;(this.queue.position = t),
                      (n = this.currentPlaybackTime),
                      (o = this.playbackState),
                      (a = this.queue.item(t)),
                      (p.label = 1)
                  case 1:
                    return (
                      p.trys.push([1, 3, , 4]),
                      [4, this._currentPlayer.playMediaItem(a, r)]
                    )
                  case 2:
                    return (
                      p.sent(),
                      'song' !== a.type
                        ? [2]
                        : null === this.nowPlayingItem
                        ? [2]
                        : ((s = this.nowPlayingItem.container),
                          (u = {
                            container: { id: s.id, name: s.name, type: s.type },
                            duration:
                              this.nowPlayingItem.playbackDuration / 1e3,
                            id: this.nowPlayingItem.id,
                            cloudId: this.nowPlayingItem.cloudId
                          }),
                          (c =
                            i === ce.TRACK_SKIPPED_BACKWARDS ||
                            i === ce.TRACK_SKIPPED_FORWARDS),
                          r && o === e.PlaybackStates.playing && c
                            ? [
                                2,
                                this._currentPlayer.playActivity.skip(u, i, n)
                              ]
                            : ((l = (c || r) && o !== e.PlaybackStates.playing),
                              [
                                2,
                                this._currentPlayer.playActivity.play(
                                  u,
                                  l ? 0 : n
                                )
                              ]))
        ...
        (SerialPlayback.prototype._getPlayerByType = function(t) {
          var r,
            i = this
          if (this._playersByType[t])
            return this._applyPlayerState(this._playersByType[t])
          switch (t) {
            case 'audio':
              r = new Xr(this._playerOptions)
              break
            default:
          ...
          return (
            ...
            r.addEventListener(Ve.playbackStateDidChange, function(t) {
              var r = t.state
              return __awaiter(i, void 0, void 0, function() {
                return __generator(this, function(t) {
                  switch (t.label) {
                    case 0:
                      return r !== e.PlaybackStates.ended
                        ? [3, 4]
                        : this.continuous
                        ? [4, this._next()]
                        : [3, 2]
                    case 1:
                      return t.sent(), [3, 4]
                    case 2:
                      return [4, this.stop(ce.NATURAL_END_OF_TRACK)]
                    case 3:
                      t.sent(), (t.label = 4)
                    case 4:
                      return [2]
            ...
            (this._playersByType[t] = r),
            this._applyPlayerState(r)
          )
        }),
                ...
                switch (r.label) {
                  case 0:
                    return this.queue.isEmpty
                      ? [2]
                      : this.repeatMode !== Cr.one
                      ? [3, 2]
                      : [4, this.seekToTime(0)]
                  case 1:
                    return r.sent(), [2, this.play()]
                  case 2:
                    return void 0 === this.queue.nextPlayableItemIndex ||
                      -1 === this.queue.nextPlayableItemIndex
                      ? [3, 3]
                      : [
                          2,
                          this._changeToMediaAtIndex(
                            this.queue.nextPlayableItemIndex,
                            t,
                            ce.TRACK_SKIPPED_FORWARDS
                          )
                        ]
                  case 3:
                    return this.repeatMode !== Cr.all
                      ? [3, 4]
                      : [2, this._changeToMediaAtIndex(0, !1)]
                  case 4:
                    return this.isPlaying
                      ? [4, this.stop(ce.TRACK_SKIPPED_FORWARDS)]
                      : [3, 6]
                  case 5:
                    r.sent(), (r.label = 6)
                  case 6:
                    ;(this._currentPlayer.playbackState =
                      e.PlaybackStates.completed),
                      (r.label = 7)
                  case 7:
                    return [2]
                }
          ...
          return (
            ...
            __awaiter(this, void 0, void 0, function() {
              return __generator(this, function(t) {
                return this.queue.isEmpty
                  ? [2]
                  : -1 !== this.queue.previousPlayableItemIndex
                  ? [
                      2,
                      this._changeToMediaAtIndex(
                        this.queue.previousPlayableItemIndex,
                        e,
                        ce.TRACK_SKIPPED_BACKWARDS
                      )
                    ]
                  : [2]
              })
    ...
    Si = (function(t) {
      function MusicKitInstance(r, i) {
        ...
        if (
          ...
          (n.version = wi),
          (n._bag = ke),
          (n._maxBitrate = e.PlaybackBitrate.STANDARD),
          (n._playbackErrorDialog = !0),
          'object' == typeof r && ((i = r), (r = void 0)),
          !r)
        )
          throw new Error('MusicKit was initialized without an developerToken.')
        Object.assign(ke.features, Te(i.features)),
          i.debug && (ke.logger.enabled = !0),
          (ke.app = i.app || {}),
          (i.affiliateToken || i.campaignToken) &&
            (i.linkParameters = Object.assign(i.linkParameters || {}, {
              at: i.affiliateToken,
              ct: i.campaignToken
            }))
        var o = new Ke(r, {
          authenticateMethod: ke.features['legacy-authenticate-method']
            ? 'POST'
            : 'GET',
        ...
        return (
          o.addEventListener(Ve.authorizationStatusDidChange, function(e) {
          ...
          o.addEventListener(Ve.userTokenDidChange, function(e) {
            n._api && (n._api.clearCacheItems(), (n._api = void 0)),
              n.dispatchEvent(Ve.userTokenDidChange, e)
          }),
          (n.storekit = ke.storekit = o),
          i.bitrate && (n.bitrate = i.bitrate),
          i.prefix &&
            /^(?:web|preview)$/.test(i.prefix) &&
            (n.prefix = ke.prefix = i.prefix),
          i.sourceType && (ke.sourceType = i.sourceType),
          i.storefrontId && (n.storefrontId = i.storefrontId),
          i.suppressErrorDialog &&
            (n._playbackErrorDialog = !i.suppressErrorDialog),
          (n.privateEnabled = i.privateEnabled || !1),
          (n.siriInitiated = i.siriInitiated || !1),
          ke.logger.debug('MusicKit JS Version: ' + n.version),
          ke.logger.debug('Link Parameters', i.linkParameters),
          ke.app && ke.logger.debug('App', ke.app),
          n
        )
      }
      return (
        __extends(MusicKitInstance, t),
        Object.defineProperty(MusicKitInstance.prototype, 'developerToken', {
          get: function() {
        ...
        Object.defineProperty(MusicKitInstance.prototype, 'api', {
          get: function() {
            if (!this._api) {
              var e = ke.features['api-session-storage']
                ? sessionStorage
                : void 0
              this._api = new st(
                ke.urls.api,
        ...
        Object.defineProperty(MusicKitInstance.prototype, 'isRestricted', {
          get: function() {
            return this.storekit.authorizationStatus === Be.RESTRICTED
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        Object.defineProperty(MusicKitInstance.prototype, 'player', {
          get: function() {
            ...
            if (!this._player) {
              this._player = new Pi({
                accurateTiming: !!ke.features['player-accurate-timing'],
              ...
              var r = Ve.bufferedProgressDidChange,
                ...
                b = Ve.queueItemsDidChange,
                m = Ve.queuePositionDidChange
              this._player.addEventListener(u, function(e) {
                return t._handlePlaybackError(e)
              }),
                this._player.addEventListener(p, function(r) {
                  ;(e.PlaybackStates.paused !== r.state &&
                    e.PlaybackStates.ended !== r.state) ||
                    t.storekit.presentSubscribeView(!1),
                    t.dispatchEvent(p, r)
                }),
                [r, i, n, o, a, s, c, y, l, d, h, f, b, m].forEach(function(e) {
        ...
        Object.defineProperty(MusicKitInstance.prototype, 'storefrontId', {
          ...
          set: function(e) {
            if (this._api && this._api.storefrontId !== e) {
              ...
              var t = ke.features['api-session-storage']
                ? sessionStorage
                : void 0
              this._api = new st(
                ke.urls.api,
                ...
                case 0:
                  return (
                    ...
                    this.storekit.userTokenIsValid
                      ? [2, this.storekit.userToken]
                      : [4, this.storekit.requestUserToken()]
                  )
                case 1:
                  return (
                    (e = r.sent()),
        ...
        (MusicKitInstance.prototype.deferPlayback = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(e) {
              switch (e.label) {
                case 0:
                  return this.player.isPlaying || this.player.isReady
                    ? [3, 2]
                    : [4, this.player.preload()]
                case 1:
                  e.sent(), (e.label = 2)
                case 2:
                  return [2]
                ...
                case 2:
                  return (
                    ...
                    [
                      2,
                      Promise.reject(
                        new re(re.AUTHORIZATION_ERROR, 'Unauthorized')
                      )
                    ]
                  )
                case 3:
          ...
          return (
            ...
            __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(i) {
                switch (i.label) {
                  case 0:
                    return !this.player.queue || this.player.queue.isEmpty
                      ? [2, this.setQueue(e)]
                      : [4, this._dataForQueueOptions(e)]
                  case 1:
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              switch (r.label) {
                ...
                case 2:
                  return (
                    r.trys.push([2, 4, , 5]), [4, this.player.seekToTime(e)]
                  )
                case 3:
                  return r.sent(), [3, 5]
                case 4:
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
              switch (t.label) {
                ...
                case 2:
                  return (
                    t.trys.push([2, 4, , 5]), [4, this.player.skipToNextItem()]
                  )
                case 3:
                  return t.sent(), [3, 5]
                case 4:
            ...
            return __generator(this, function(t) {
              switch (t.label) {
                ...
                case 2:
                  return (
                    t.trys.push([2, 4, , 5]),
                    [4, this.player.skipToPreviousItem()]
                  )
                case 3:
                  return t.sent(), [3, 5]
                case 4:
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
              switch (t.label) {
                ...
                case 2:
                  return (
                    t.trys.push([2, 4, , 5]), [4, this.player.seekForward()]
                  )
                case 3:
                  return t.sent(), [3, 5]
                case 4:
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
              switch (t.label) {
                ...
                case 2:
                  return (
                    t.trys.push([2, 4, , 5]), [4, this.player.seekBackward()]
                  )
                case 3:
                  return t.sent(), [3, 5]
                case 4:
              ...
              switch (p.label) {
                case 0:
                  if (
                    ...
                    throw new re(
                      re.UNSUPPORTED_ERROR,
                      'station is not a supported option.'
                    )
                  return (
                    e.albums && (e.album = e.albums[0]),
                    e.playlists && (e.playlist = e.playlists[0]),
                    e.song && (e.songs = [e.song]),
                    (a = e.songs ? e.songs[0] : e.album || e.playlist)
                      ? ((s = isLibraryType(a)),
                        (u = s ? this.api.library : this.api),
                        s ? [4, this.authorize()] : [3, 2])
                      : [3, 8]
                  )
                case 1:
                  p.sent(), (p.label = 2)
                case 2:
                  return e.album
                    ? ((c = t), [4, u.album(a, e.parameters)])
                    : [3, 4]
                case 3:
                  return (c.loaded = p.sent()), [3, 8]
                case 4:
                  return e.playlist
                    ? ((l = t), [4, u.playlist(a, e.parameters)])
                    : [3, 6]
                case 5:
                  return (l.loaded = p.sent()), [3, 8]
                case 6:
                  return e.songs
                    ? ((d = t), [4, u.songs(e.songs, e.parameters)])
                    : [3, 8]
                case 7:
        ...
        (MusicKitInstance.prototype._handlePlaybackError = function(e) {
          ...
          ke.logger.log('mediaPlaybackError', e),
            this.dispatchEvent(Ve.mediaPlaybackError, e),
            this._playbackErrorDialog &&
              e.hasOwnProperty('presentDialog') &&
              e.presentDialog()
        }),
    ...
    Ti = (function() {
      function DOMSupport(e, t) {
        void 0 === e && (e = void 0), void 0 === t && (t = ki.classes)
        var r = this
        if (
          ((this.elements = e),
          (this.classes = t),
          !document || 'function' != typeof MutationObserver || !e)
        )
          return (this.elements = void 0), void (this.identifiers = [])
        ;(this.identifiers = Object.keys(e)),
          ...
          new MutationObserver(this._mutationDidOccur.bind(this)).observe(
            document.body,
            {
              attributes: !0,
              childList: !0,
      ...
      return (
        (DOMSupport.prototype.attach = function(e, t) {
          void 0 === t && (t = this.elements[e.id]),
            !e.innerText && t.defaultText && (e.innerText = t.defaultText),
            t.click && e.addEventListener('mouseup', t.click),
            this._renderDefinition(e, t)
        }),
        (DOMSupport.prototype.detach = function(e, t) {
          void 0 === t && (t = this.elements[e.id]),
            t && t.click && e.removeEventListener('mouseup', t.click)
        }),
        (DOMSupport.prototype.update = function(e) {
          var t = this
          void 0 === e && (e = this.identifiers),
            this.elements &&
              Ei(function() {
                e.forEach(function(e) {
                  for (
                    var r = t.elements[e],
                      i = t._nodesForDefinitionId(e),
                      n = 0;
                    n < i.length;
                    ++n
                  ) {
          ...
          e.forEach(function(e) {
            ...
            for (
              var i = function(r) {
                  ...
                  i.id && t.elements[i.id] && t.attach(i, t.elements[i.id]),
                    t.identifiers.forEach(function(e) {
            ...
            for (
              var o = function(r) {
                  ...
                  if (!i.id && !i.dataset) return 'continue'
                  i.id && t.elements[i.id] && t.detach(i, t.elements[i.id]),
                    t.identifiers.forEach(function(e) {
        ...
        (DOMSupport.prototype._renderDefinition = function(e, t) {
          ...
          Ei(function() {
            i ? e.removeAttribute('disabled') : e.setAttribute('disabled', !0),
              (e.style.display = n ? r.classes.SHOW : r.classes.HIDE),
              n &&
                0 === e.children.length &&
                t.content &&
                (e.innerText = t.content(e))
          })
        }),
        DOMSupport
      )
    })(),
    Ii = /^http(?:s)?\:\/\/(?:itunes|(embed\.)?(music|podcast))\.apple\.com/i,
    Ai = [
      'allow-forms',
      'allow-popups',
      'allow-same-origin',
  ...
  function configure(e) {
    ...
    return (
      d &&
        Ri &&
        window.location &&
        (e.linkParameters = Object.assign(
          e.linkParameters || {},
          Oe(window.location.href)
        )),
      Ci && Ci.cleanup(),
      (Ci = new Si(l, e)),
      c &&
        ...
        (a = {
          ...
          content: function(e) {
            return formatMediaTime(
              e.togglePlaybackTime
                ? t.player.currentPlaybackDuration
                : t.player.currentPlaybackTimeRemaining
            )
          },
          display: function() {
            return t.player.nowPlayingItem
          ...
          'data-apple-music-now-playing': {
            content: function(e) {
              var r = e.dataset.appleMusicNowPlaying || 'info',
                i = Ge(t.player.nowPlayingItem, r)
              if (!(/artworkurl$/i.test(r) && e.height && e.width)) return i
              e.src = formatArtworkURL({ url: i }, e.height, e.width)
            },
            display: function() {
              return t.player.nowPlayingItem
            }
          ...
          'data-apple-music-set-queue': {
            click: function(e) {
              var r = e.target.dataset,
                ...
                o = r.appleMusicType
              if (isPlayingContainerOrItem(n, t.player.nowPlayingItem))
                return t.player.isPlaying ? t.pause() : t.play()
              o ||
                (o = ie.test(n)
                  ? 'url'
                  : /^pl\./i.test(n)
            ...
            display: function(e) {
              if (t.player.nowPlayingItem) {
                ...
                r.appleMusicType,
                  isPlayingContainerOrItem(i, t.player.nowPlayingItem)
                    ? e.classList.add(Oi)
        ...
        t.addEventListener(Ve.authorizationStatusDidChange, function() {
          u.update([
            'apple-music-authorize',
            'apple-music-unauthorize',
            'data-apple-music-authorize',
        ...
        t.addEventListener(Ve.playbackDurationDidChange, function() {
          u.update([
            'apple-music-current-playback-duration',
            'data-apple-music-current-playback-duration'
          ])
        }),
        t.addEventListener(Ve.playbackProgressDidChange, function() {
          u.update([
            'apple-music-current-playback-progress',
            'data-apple-music-current-playback-progress'
          ])
        }),
        t.addEventListener(Ve.playbackTimeDidChange, function() {
          u.update([
            'apple-music-current-playback-time',
            'apple-music-current-playback-time-remaining',
            'data-apple-music-current-playback-time',
            'data-apple-music-current-playback-time-remaining'
          ])
        }),
      ...
      dispatchDocumentEvent(Ve.configured),
      Ci
    )
  }
  if (Ri) {
    ...
    var Mi = (function() {
        ...
        var e,
          t = meta('apple-music-developer-token') || meta('JWT'),
      ...
      Li = /interactive|complete|loaded/.test(document.readyState)
    Mi &&
      Mi.developerToken &&
      !Li &&
      !Ci &&
      ((Mi.declarativeMarkup = !0),
  ...
  ;(e.errors = Di),
    ...
    (e.formatMediaTime = formatMediaTime),
    (e.configure = configure),
    (e.getInstance = function() {
      if (!Ci) throw new re(re.CONFIGURATION_ERROR, 'No configured instance')
      return Ci
    }),
    (e.Queue = St),
    (e.version = wi),
    ...
    (e.generateEmbedCode = function(e, t) {
      if ((void 0 === t && (t = { height: '450', width: '660' }), !Ii.test(e)))
        throw new Error('Invalid content url')
      'song' === formattedMediaURL(e).kind && (t.height = '150'),
        (t.height = ('' + t.height).replace(/(\d+)px/i, '$1')),
        (t.width = ('' + t.width).replace(/^(\d+)(?!px)%?$/i, '$1px'))
      var r =
          'width:100%;max-width:' +
          t.width +
          ';overflow:hidden;background:transparent;',
        i =
          window.localStorage.getItem('mk-generate-swizzle') ||
          'https://embed.music.apple.com'
      return (
        '<iframe allow="autoplay *; encrypted-media *;" frameborder="0" height="' +
        t.height +
        '" style="' +
        r +
        '" sandbox="' +
